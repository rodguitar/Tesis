...
public b4a.example.graficos.main _main = null;
...
public boolean IsInitialized;
public b4a.example.graficos.charts._graphinternal GI;
public String Title;
public String YAxis;
public String XAxis;
public float YStart;
...
public void Initialize() {
IsInitialized = true;
GI = new b4a.example.graficos.charts._graphinternal();
Title = "";
YAxis = "";
XAxis = "";
YStart = 0f;
...
public static String  _addbarcolor(anywheresoftware.b4a.BA _ba,b4a.example.graficos.charts._bardata _bd,int _color) throws Exception{
 //BA.debugLineNum = 46;BA.debugLine="Sub AddBarColor(BD As BarData, Color As Int)";
 //BA.debugLineNum = 47;BA.debugLine="If BD.BarsColors.IsInitialized = False Then BD.Ba";
...
public static String  _addbarpoint(anywheresoftware.b4a.BA _ba,b4a.example.graficos.charts._bardata _bd,String _x,float[] _yarray) throws Exception{
b4a.example.graficos.charts._linepoint _b = null;
 //BA.debugLineNum = 28;BA.debugLine="Sub AddBarPoint (BD As BarData, X As String, YArra";
...
_b = new b4a.example.graficos.charts._linepoint();
...
_bd.Points.Add((Object)(_b));
 ...
 //BA.debugLineNum = 38;BA.debugLine="Dim b As LinePoint 'using the same structure of L";
_b = new b4a.example.graficos.charts._linepoint();
...
public static String  _addlinecolor(anywheresoftware.b4a.BA _ba,b4a.example.graficos.charts._linedata _ld,int _color) throws Exception{
 //BA.debugLineNum = 196;BA.debugLine="Sub AddLineColor(LD As LineData, Color As Int)";
 //BA.debugLineNum = 197;BA.debugLine="If LD.LinesColors.IsInitialized = False Then LD.L";
...
public static String  _addlinemultiplepoints(anywheresoftware.b4a.BA _ba,b4a.example.graficos.charts._linedata _ld,String _x,float[] _yarray,boolean _showtick) throws Exception{
b4a.example.graficos.charts._linepoint _p = null;
 //BA.debugLineNum = 186;BA.debugLine="Sub AddLineMultiplePoints(LD As LineData, X As Str";
 //BA.debugLineNum = 187;BA.debugLine="If LD.Points.IsInitialized = False Then LD.Points";
...
_p = new b4a.example.graficos.charts._linepoint();
...
public static String  _addlinepoint(anywheresoftware.b4a.BA _ba,b4a.example.graficos.charts._linedata _ld,String _x,float _y,boolean _showtick) throws Exception{
b4a.example.graficos.charts._linepoint _p = null;
 //BA.debugLineNum = 176;BA.debugLine="Sub AddLinePoint (LD As LineData, X As String, Y A";
 //BA.debugLineNum = 177;BA.debugLine="If LD.Points.IsInitialized = False Then LD.Points";
if (_ld.Points.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
_ld.Points.Initialize();};
...
public static String  _addpieitem(anywheresoftware.b4a.BA _ba,b4a.example.graficos.charts._piedata _pd,String _name,float _value,int _color) throws Exception{
b4a.example.graficos.charts._pieitem _i = null;
 //BA.debugLineNum = 258;BA.debugLine="Sub AddPieItem(PD As PieData, Name As String, Valu";
 //BA.debugLineNum = 259;BA.debugLine="If PD.Items.IsInitialized = False Then PD.Items.I";
if (_pd.Items.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
_pd.Items.Initialize();};
 //BA.debugLineNum = 260;BA.debugLine="If Color = 0 Then Color = Colors.RGB(Rnd(0, 255),";
if (_color==0) { 
...
_i = new b4a.example.graficos.charts._pieitem();
...
public static int  _calcpointtopixel(anywheresoftware.b4a.BA _ba,float _py,b4a.example.graficos.charts._graph _g) throws Exception{
 //BA.debugLineNum = 248;BA.debugLine="Sub calcPointToPixel(py As Float, G As Graph) As I";
 //BA.debugLineNum = 249;BA.debugLine="If G.YStart < 0 AND G.YEnd > 0 Then";
if (_g.YStart<0 && _g.YEnd>0) { 
 //BA.debugLineNum = 250;BA.debugLine="Return G.GI.zeroY - (G.GI.originY - G.GI.maxY) *";
if (true) return (int) (_g.GI.zeroY-(_g.GI.originY-_g.GI.maxY)*_py/(double)(_g.YEnd-_g.YStart));
 }else {
 //BA.debugLineNum = 252;BA.debugLine="Return G.GI.originY - (G.GI.originY - G.GI.maxY)";
if (true) return (int) (_g.GI.originY-(_g.GI.originY-_g.GI.maxY)*(_py-_g.YStart)/(double)(_g.YEnd-_g.YStart));
 };
 //BA.debugLineNum = 254;BA.debugLine="End Sub";
return 0;
}
public static String  _calcscale(anywheresoftware.b4a.BA _ba,b4a.example.graficos.charts._graph _g,b4a.example.graficos.charts._linedata _ld) throws Exception{
double _scalelog = 0;
double _scalemant = 0;
double _scaleexp = 0;
...
double[] _valminmax = null;
 ...
 //BA.debugLineNum = 414;BA.debugLine="Dim ScaleLog, ScaleMant, ScaleExp, ScaleDelta, Va";
_scalelog = 0;
_scalemant = 0;
_scaleexp = 0;
_scaledelta = 0;
...
_log5 = 0;
_log10 = 0;
 //BA.debugLineNum = 417;BA.debugLine="Dim nbMin, NbUsedIntervals, NbUsedIntervalsTop, N";
_nbmin = 0;
_nbusedintervals = 0;
...
_scaleinterval = 1;
 //BA.debugLineNum = 425;BA.debugLine="ScaleMin = Floor(ValMinMax(0)) -ScaleInterval *";
_scalemin = anywheresoftware.b4a.keywords.Common.Floor(_valminmax[(int) (0)])-_scaleinterval*_g.NbIntervals/(double)2;
 //BA.debugLineNum = 426;BA.debugLine="ScaleMax = ScaleMin + ScaleInterval * G.NbInterv";
...
if (_valminmax[(int) (0)]<0 && _valminmax[(int) (1)]>0) { 
 //BA.debugLineNum = 467;BA.debugLine="NbUsedIntervalsTop = Ceil(ValMinMax(1) / ScaleIn";
_nbusedintervalstop = (int) (anywheresoftware.b4a.keywords.Common.Ceil(_valminmax[(int) (1)]/(double)_scaleinterval-0.00000000000001));
 //BA.debugLineNum = 468;BA.debugLine="NbUsedIntervalsBottom = Ceil(Abs(ValMinMax(0)) /";
_nbusedintervalsbottom = (int) (anywheresoftware.b4a.keywords.Common.Ceil(anywheresoftware.b4a.keywords.Common.Abs(_valminmax[(int) (0)])/(double)_scaleinterval-0.00000000000001));
 //BA.debugLineNum = 470;BA.debugLine="If NbUsedIntervalsTop + NbUsedIntervalsBottom >";
...
_scalemin = _nbmin*_scaleinterval;
 ...
 //BA.debugLineNum = 494;BA.debugLine="ScaleMin = Floor(ValMinMax(0) / ScaleInterval +";
_scalemin = anywheresoftware.b4a.keywords.Common.Floor(_valminmax[(int) (0)]/(double)_scaleinterval+0.00000000000001)*_scaleinterval;
 ...
 //BA.debugLineNum = 496;BA.debugLine="ScaleMin = Floor(ValMinMax(0) / ScaleInterval +";
_scalemin = anywheresoftware.b4a.keywords.Common.Floor(_valminmax[(int) (0)]/(double)_scaleinterval+0.00000000000001)*_scaleinterval;
 };
...
if (_valminmax[(int) (0)]<0 && _valminmax[(int) (1)]>0) { 
 //BA.debugLineNum = 502;BA.debugLine="NbUsedIntervalsTop = Ceil(ValMinMax(1) / ScaleI";
_nbusedintervalstop = (int) (anywheresoftware.b4a.keywords.Common.Ceil(_valminmax[(int) (1)]/(double)_scaleinterval-0.00000000000001));
 //BA.debugLineNum = 503;BA.debugLine="NbUsedIntervalsBottom = Ceil(Abs(ValMinMax(0))";
_nbusedintervalsbottom = (int) (anywheresoftware.b4a.keywords.Common.Ceil(anywheresoftware.b4a.keywords.Common.Abs(_valminmax[(int) (0)])/(double)_scaleinterval-0.00000000000001));
 //BA.debugLineNum = 504;BA.debugLine="NbUsedIntervals = NbUsedIntervalsTop + NbUsedIn";
_nbusedintervals = (int) (_nbusedintervalstop+_nbusedintervalsbottom);
 //BA.debugLineNum = 505;BA.debugLine="If NbUsedIntervalsTop - NbUsedIntervalsBottom =";
if (_nbusedintervalstop-_nbusedintervalsbottom==1) { 
 //BA.debugLineNum = 506;BA.debugLine="NbIntervalsToMove = G.NbIntervals / 2 - NbUsed";
_nbintervalstomove = (int) (_g.NbIntervals/(double)2-_nbusedintervalsbottom);
 }else {
 //BA.debugLineNum = 508;BA.debugLine="NbIntervalsToMove = (G.NbIntervals - NbUsedInt";
_nbintervalstomove = (int) ((_g.NbIntervals-_nbusedintervals)/(double)2);
 };
 }else {
 //BA.debugLineNum = 511;BA.debugLine="NbUsedIntervals = Ceil(ValDiff / ScaleInterval";
_nbusedintervals = (int) (anywheresoftware.b4a.keywords.Common.Ceil(_valdiff/(double)_scaleinterval-0.00000000000001));
 //BA.debugLineNum = 512;BA.debugLine="NbIntervalsToMove = (G.NbIntervals - NbUsedInte";
_nbintervalstomove = (int) ((_g.NbIntervals-_nbusedintervals)/(double)2);
 };
 //BA.debugLineNum = 514;BA.debugLine="ScaleMin = ScaleMin - ScaleInterval * NbInterval";
_scalemin = _scalemin-_scaleinterval*_nbintervalstomove;
 };
 //BA.debugLineNum = 518;BA.debugLine="ScaleMax = ScaleMin + ScaleInterval * G.NbInterva";
_scalemax = _scalemin+_scaleinterval*_g.NbIntervals;
...
float _gap = 0f;
int _i = 0;
 //BA.debugLineNum = 303;BA.debugLine="Sub calcSlice(Canvas As Canvas, Radius As Int, _";
...
_gap = (float) (_percent*_gapdegrees/(double)2);
 //BA.debugLineNum = 315;BA.debugLine="For i = StartingDegree + gap To StartingDegree +";
{
...
for (_i = (int) (_startingdegree+_gap); (step257 > 0 && _i <= limit257) || (step257 < 0 && _i >= limit257); _i = ((int)(0 + _i + step257))) {
 //BA.debugLineNum = 316;BA.debugLine="p.LineTo(cx + 2 * Radius * SinD(i), cy + 2 * Rad";
_p.LineTo((float) (_cx+2*_radius*anywheresoftware.b4a.keywords.Common.SinD(_i)),(float) (_cy+2*_radius*anywheresoftware.b4a.keywords.Common.CosD(_i)));
 ...
 //BA.debugLineNum = 318;BA.debugLine="p.LineTo(cx + 2 * Radius * SinD(StartingDegree +";
...
_p.LineTo((float) (_cx),(float) (_cy));
 //BA.debugLineNum = 320;BA.debugLine="Canvas.ClipPath(p) 'We are limiting the drawings";
...
public static anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _createlegend(anywheresoftware.b4a.BA _ba,b4a.example.graficos.charts._piedata _pd) throws Exception{
anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _bmp = null;
float _textheight = 0f;
float _textwidth = 0f;
int _i = 0;
b4a.example.graficos.charts._pieitem _it = null;
...
_bmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 328;BA.debugLine="If PD.LegendTextSize = 0 Then PD.LegendTextSize =";
if (_pd.LegendTextSize==0) { 
_pd.LegendTextSize = (float) (15);};
 //BA.debugLineNum = 329;BA.debugLine="Dim textHeight, textWidth As Float";
_textheight = 0f;
_textwidth = 0f;
 //BA.debugLineNum = 330;BA.debugLine="textHeight = PD.Canvas.MeasureStringHeight(\"M\", T";
...
_it = new b4a.example.graficos.charts._pieitem();
 //BA.debugLineNum = 333;BA.debugLine="it = PD.Items.Get(i)";
_it = (b4a.example.graficos.charts._pieitem)(_pd.Items.Get(_i));
 //BA.debugLineNum = 334;BA.debugLine="textWidth = Max(textWidth, PD.Canvas.MeasureStri";
_textwidth = (float) (anywheresoftware.b4a.keywords.Common.Max(_textwidth,_pd.Canvas.MeasureStringWidth(_it.Name,anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD,_pd.LegendTextSize)));
 ...
 //BA.debugLineNum = 336;BA.debugLine="bmp.InitializeMutable(textWidth + 20dip, 10dip +(";
...
_it = (b4a.example.graficos.charts._pieitem)(_pd.Items.Get(_i));
 //BA.debugLineNum = 343;BA.debugLine="c.DrawText(it.Name, 10dip, (i + 1) * (textHeight";
...
public static String  _drawbarschart(anywheresoftware.b4a.BA _ba,b4a.example.graficos.charts._graph _g,b4a.example.graficos.charts._bardata _bd,int _backcolor) throws Exception{
b4a.example.graficos.charts._linepoint _point = null;
anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper _rect = null;
int _numberofbars = 0;
int _i = 0;
int _a = 0;
 //BA.debugLineNum = 51;BA.debugLine="Sub DrawBarsChart(G As Graph, BD As BarData, BackC";
...
_point = new b4a.example.graficos.charts._linepoint();
 //BA.debugLineNum = 59;BA.debugLine="point = BD.Points.Get(1)";
_point = (b4a.example.graficos.charts._linepoint)(_bd.Points.Get((int) (1)));
 //BA.debugLineNum = 60;BA.debugLine="If BD.Stacked = False Then";
if (_bd.Stacked==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 61;BA.debugLine="drawGraph(G, BD.Canvas, BD.Target, BD.Points, Tr";
_drawgraph(_ba,_g,_bd.Canvas,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_bd.Target.getObject())),_bd.Points,anywheresoftware.b4a.keywords.Common.True,_bd.BarsWidth);
 ...
 //BA.debugLineNum = 64;BA.debugLine="drawGraph(G, BD.Canvas, BD.Target, BD.Points, Tr";
...
_point = (b4a.example.graficos.charts._linepoint)(_bd.Points.Get(_i));
...
if (_bd.Stacked==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 77;BA.debugLine="Rect.Left = G.GI.originX + G.GI.intervalX * (i";
...
if (_point.YArray[_a]>0) { 
 //BA.debugLineNum = 81;BA.debugLine="Rect.Top = calcPointToPixel(point.YArray(a),";
...
_rect.setBottom(_g.GI.zeroY);
 ...
 //BA.debugLineNum = 84;BA.debugLine="Rect.Bottom = calcPointToPixel(point.YArray(";
...
_rect.setTop(_g.GI.zeroY);
 ...
 //BA.debugLineNum = 88;BA.debugLine="Rect.Top = calcPointToPixel(point.YArray(a),";
_rect.setTop(_calcpointtopixel(_ba,_point.YArray[_a],_g));
 //BA.debugLineNum = 89;BA.debugLine="Rect.Bottom = G.GI.originY";
_rect.setBottom(_g.GI.originY);
 };
 }else {
 //BA.debugLineNum = 92;BA.debugLine="Rect.Left = G.GI.originX + G.GI.intervalX * (i";
...
_rect.setBottom(_rect.getTop());
 //BA.debugLineNum = 98;BA.debugLine="Rect.Top = Rect.Bottom + calcPointToPixel(poin";
_rect.setTop((int) (_rect.getBottom()+_calcpointtopixel(_ba,_point.YArray[_a],_g)-_g.GI.originY));
 };
 //BA.debugLineNum = 100;BA.debugLine="BD.Canvas.DrawRect(Rect, BD.BarsColors.Get(a),";
...
public static String  _drawgraph(anywheresoftware.b4a.BA _ba,b4a.example.graficos.charts._graph _g,anywheresoftware.b4a.objects.drawable.CanvasWrapper _canvas,anywheresoftware.b4a.objects.ConcreteViewWrapper _target,anywheresoftware.b4a.objects.collections.List _points,boolean _bars,int _barswidth) throws Exception{
b4a.example.graficos.charts._graphinternal _gi = null;
b4a.example.graficos.charts._linepoint _p = null;
int _i = 0;
int _y = 0;
float _yvalue = 0f;
int _x = 0;
 //BA.debugLineNum = 108;BA.debugLine="Sub drawGraph (G As Graph, Canvas As Canvas, Targe";
 //BA.debugLineNum = 109;BA.debugLine="Dim GI As GraphInternal";
_gi = new b4a.example.graficos.charts._graphinternal();
...
_gi.originX = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50));
 //BA.debugLineNum = 114;BA.debugLine="GI.originY = Target.Height - 70dip			'bottom marg";
...
if (_g.YStart<0 && _g.YEnd>0) { 
 //BA.debugLineNum = 118;BA.debugLine="GI.zeroY = GI.maxY + GI.gh * G.YEnd / (G.YEnd -";
...
_p = (b4a.example.graficos.charts._linepoint)(_points.Get((int) (1)));
 //BA.debugLineNum = 125;BA.debugLine="GI.intervalX = (GI.gw - p.YArray.Length / 2 * Ba";
...
_gi.intervalX = (float) (_gi.gw/(double)(_points.getSize()-1));
 ...
 //BA.debugLineNum = 130;BA.debugLine="Canvas.DrawLine(GI.originX, GI.originY + 2dip, GI";
_canvas.DrawLine((float) (_gi.originX),(float) (_gi.originY+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))),(float) (_gi.originX),(float) (_gi.maxY-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))),_g.AxisColor,(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))));
 //BA.debugLineNum = 131;BA.debugLine="For i = 0 To (G.YEnd - G.YStart) / G.Yinterval +";
{
final int step101 = 1;
...
_y = _calcpointtopixel(_ba,_yvalue,_g);
 //BA.debugLineNum = 137;BA.debugLine="Canvas.DrawLine(GI.originX, y, GI.originX - 5dip";
...
if (_i<(_g.YEnd-_g.YStart)/(double)_g.YInterval) { 
 //BA.debugLineNum = 139;BA.debugLine="Canvas.DrawLine(GI.originX, y, GI.originX + GI.";
_canvas.DrawLine((float) (_gi.originX),(float) (_y),(float) (_gi.originX+_gi.gw),(float) (_y),_g.AxisColor,(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1))));
 ...
 //BA.debugLineNum = 141;BA.debugLine="Canvas.DrawLine(GI.originX, y, GI.originX + GI.";
_canvas.DrawLine((float) (_gi.originX),(float) (_y),(float) (_gi.originX+_gi.gw),(float) (_y),_g.AxisColor,(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))));
 ...
 //BA.debugLineNum = 143;BA.debugLine="Canvas.DrawText(NumberFormat(yValue, 1, 2), GI.o";
_canvas.DrawText(_ba,anywheresoftware.b4a.keywords.Common.NumberFormat(_yvalue,(int) (1),(int) (2)),(float) (_gi.originX-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (8))),(float) (_y+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))),anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT,(float) (mostCurrent._main._fontsize-3),_g.AxisColor,BA.getEnumFromString(android.graphics.Paint.Align.class,"RIGHT"));
 ...
 //BA.debugLineNum = 146;BA.debugLine="Canvas.DrawLine(GI.originX+ GI.gw, GI.originY + 1";
_canvas.DrawLine((float) (_gi.originX+_gi.gw),(float) (_gi.originY+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1))),(float) (_gi.originX+_gi.gw),(float) (_gi.maxY-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1))),_g.AxisColor,(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))));
 //BA.debugLineNum = 148;BA.debugLine="Canvas.DrawText(G.Title, Target.Width / 2, 30dip,";
_canvas.DrawText(_ba,_g.Title,(float) (_target.getWidth()/(double)2),(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD,(float) (mostCurrent._main._fontsize-2),_g.AxisColor,BA.getEnumFromString(android.graphics.Paint.Align.class,"CENTER"));
 //BA.debugLineNum = 149;BA.debugLine="Canvas.DrawText(G.XAxis, Target.Width / 2, GI.ori";
_canvas.DrawText(_ba,_g.XAxis,(float) (_target.getWidth()/(double)2),(float) (_gi.originY+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60))),anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT,(float) (mostCurrent._main._fontsize-3),_g.AxisColor,BA.getEnumFromString(android.graphics.Paint.Align.class,"CENTER"));
 //BA.debugLineNum = 150;BA.debugLine="Canvas.DrawTextRotated(G.YAxis, 15dip, Target.Hei";
_canvas.DrawTextRotated(_ba,_g.YAxis,(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (15))),(float) (_target.getHeight()/(double)2),anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT,(float) (mostCurrent._main._fontsize-3),_g.AxisColor,BA.getEnumFromString(android.graphics.Paint.Align.class,"CENTER"),(float) (-90));
 //BA.debugLineNum = 152;BA.debugLine="Canvas.DrawLine(GI.originX, GI.originY, GI.origin";
...
_p = (b4a.example.graficos.charts._linepoint)(_points.Get(_i));
...
if (_i<_points.getSize()-1) { 
 //BA.debugLineNum = 161;BA.debugLine="Canvas.DrawLine(x, GI.originY, x, GI.maxY, G.";
...
_x = (int) (_gi.originX+(_i-0.5)*_gi.intervalX);
 //BA.debugLineNum = 165;BA.debugLine="Canvas.DrawLine(x, GI.originY, x, GI.originY +";
...
if (_p.X.length()>0) { 
 //BA.debugLineNum = 168;BA.debugLine="Canvas.DrawTextRotated(p.x, x, GI.originY + 12";
...
public static String  _drawhorizontallinetext(anywheresoftware.b4a.BA _ba,b4a.example.graficos.charts._graph _g,b4a.example.graficos.charts._bardata _bd,double _y,int _color,float _stroke,String _text,String _align) throws Exception{
float _x1 = 0f;
float _x2 = 0f;
float _y1 = 0f;
 //BA.debugLineNum = 362;BA.debugLine="Sub DrawHorizontalLineText(G As Graph, BD As BarDa";
...
_x2 = (float) (_g.GI.originX+_g.GI.gw);
 //BA.debugLineNum = 366;BA.debugLine="y1 = G.GI.maxY + (G.YEnd - y) * G.GI.gh / (G.YEnd";
...
case 0:
 //BA.debugLineNum = 370;BA.debugLine="BD.Canvas.DrawText(Text, x1 - 2dip, y1 + 4dip, T";
_bd.Canvas.DrawText(_ba,_text,(float) (_x1-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))),(float) (_y1+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT,(float) (mostCurrent._main._fontsize-3),_color,BA.getEnumFromString(android.graphics.Paint.Align.class,"RIGHT"));
 break;
case 1:
 //BA.debugLineNum = 372;BA.debugLine="BD.Canvas.DrawText(Text, x1 + 2dip, y1 - 2dip, T";
_bd.Canvas.DrawText(_ba,_text,(float) (_x1+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))),(float) (_y1-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))),anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT,(float) (mostCurrent._main._fontsize-3),_color,BA.getEnumFromString(android.graphics.Paint.Align.class,"LEFT"));
 break;
case 2:
 //BA.debugLineNum = 374;BA.debugLine="BD.Canvas.DrawText(Text, (x1 + x2) / 2, y1 - 2di";
_bd.Canvas.DrawText(_ba,_text,(float) ((_x1+_x2)/(double)2),(float) (_y1-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))),anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT,(float) (mostCurrent._main._fontsize-3),_color,BA.getEnumFromString(android.graphics.Paint.Align.class,"CENTER"));
 break;
case 3:
 //BA.debugLineNum = 376;BA.debugLine="BD.Canvas.DrawText(Text, x2 + 2dip, y1 + 4dip, T";
...
public static String  _drawlinechart(anywheresoftware.b4a.BA _ba,b4a.example.graficos.charts._graph _g,b4a.example.graficos.charts._linedata _ld,int _backcolor) throws Exception{
b4a.example.graficos.charts._linepoint _point = null;
float[] _py2 = null;
int _i = 0;
int _a = 0;
float _py = 0f;
 //BA.debugLineNum = 201;BA.debugLine="Sub DrawLineChart(G As Graph, LD As LineData, Back";
...
_calcscale(_ba,_g,_ld);
 ...
 //BA.debugLineNum = 214;BA.debugLine="drawGraph(G, LD.Canvas, LD.Target, LD.Points, Fal";
...
_point = (b4a.example.graficos.charts._linepoint)(_ld.Points.Get((int) (0)));
...
_point = (b4a.example.graficos.charts._linepoint)(_ld.Points.Get(_i));
...
for (_a = (int) (0); (step183 > 0 && _a <= limit183) || (step183 < 0 && _a >= limit183); _a = ((int)(0 + _a + step183))) {
 //BA.debugLineNum = 230;BA.debugLine="LD.Canvas.DrawLine(G.GI.originX + G.GI.interva";
...
_point = (b4a.example.graficos.charts._linepoint)(_ld.Points.Get(_i));
 //BA.debugLineNum = 240;BA.debugLine="LD.Canvas.DrawLine(G.GI.originX + G.GI.interval";
...
public static anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _drawpie(anywheresoftware.b4a.BA _ba,b4a.example.graficos.charts._piedata _pd,int _backcolor,boolean _createlegendbitmap) throws Exception{
int _radius = 0;
int _total = 0;
int _i = 0;
b4a.example.graficos.charts._pieitem _it = null;
...
int _gapdegrees = 0;
 //BA.debugLineNum = 269;BA.debugLine="Sub DrawPie (PD As PieData, BackColor As Int, Crea";
...
_radius = 0;
 //BA.debugLineNum = 277;BA.debugLine="Radius = Min(PD.Canvas.Bitmap.Width, PD.Canvas.Bi";
...
_gapdegrees = 0;
 //BA.debugLineNum = 287;BA.debugLine="If PD.Items.Size = 1 Then GapDegrees = 0 Else Gap";
...
_it = (b4a.example.graficos.charts._pieitem)(_pd.Items.Get(_i));
 //BA.debugLineNum = 291;BA.debugLine="startingAngle = startingAngle + _  			calcSlice(";
...
public static double[]  _getlineminmaxvalues(anywheresoftware.b4a.BA _ba,b4a.example.graficos.charts._linedata _ld) throws Exception{
int _j = 0;
b4a.example.graficos.charts._linepoint _points = null;
double[] _minmax = null;
int _i = 0;
float[] _yvals = null;
...
_points = new b4a.example.graficos.charts._linepoint();
...
_points = (b4a.example.graficos.charts._linepoint)(_ld.Points.Get(_i));
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 13;BA.debugLine="Type PieItem (Name As String, Value As Float, Col";
;
 //BA.debugLineNum = 14;BA.debugLine="Type PieData (Items As List, Target As Panel, Can";
;
 //BA.debugLineNum = 16;BA.debugLine="Type GraphInternal (originX As Int, zeroY As Int,";
;
 //BA.debugLineNum = 19;BA.debugLine="Type Graph (GI As GraphInternal, Title As String,";
;
 //BA.debugLineNum = 21;BA.debugLine="Type LinePoint (X As String, Y As Float, YArray()";
;
 //BA.debugLineNum = 23;BA.debugLine="Type LineData (Points As List, LinesColors As Lis";
;
 //BA.debugLineNum = 24;BA.debugLine="Type BarData (Points As List, BarsColors As List,";
;

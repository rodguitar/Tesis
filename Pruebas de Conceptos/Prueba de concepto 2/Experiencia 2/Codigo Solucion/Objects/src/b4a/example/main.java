...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 46;BA.debugLine="If FirstTime=True Then";
if (_firsttime==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 47;BA.debugLine="DBApp.CreaBD";
mostCurrent._dbapp._creabd(mostCurrent.activityBA);
 };
 //BA.debugLineNum = 49;BA.debugLine="GD.SetOnGestureListener(Activity, \"Gesture\")";
mostCurrent._gd.SetOnGestureListener(processBA,(android.view.View)(mostCurrent._activity.getObject()),"Gesture");
 //BA.debugLineNum = 51;BA.debugLine="TabHost1.Initialize(\"TabHost1\")";
mostCurrent._tabhost1.Initialize(mostCurrent.activityBA,"TabHost1");
 //BA.debugLineNum = 54;BA.debugLine="Activity.AddView(TabHost1, 0, 0, 100%x, 100%y)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._tabhost1.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 55;BA.debugLine="TabHost1.AddTab(\"Ingreso de Reseñas\",\"Layout1\")";
mostCurrent._tabhost1.AddTab(mostCurrent.activityBA,"Ingreso de Reseñas","Layout1");
 //BA.debugLineNum = 56;BA.debugLine="Activity.Title=\"Desafío 1\"";
mostCurrent._activity.setTitle((Object)("Desafío 1"));
 //BA.debugLineNum = 58;BA.debugLine="listaIngresos.Initialize";
mostCurrent._listaingresos.Initialize();
 //BA.debugLineNum = 60;BA.debugLine="LLenaSpinnerNota";
_llenaspinnernota();
...
mostCurrent._spinnertipo.Add("Voz");
 //BA.debugLineNum = 64;BA.debugLine="TabGraficoPie";
_tabgraficopie();
...
String _k = "";
 //BA.debugLineNum = 87;BA.debugLine="Sub addValorGrafico(datos As Map)";
 //BA.debugLineNum = 89;BA.debugLine="Dim PD As PieData";
_pd = new b4a.example.charts._piedata();
 //BA.debugLineNum = 90;BA.debugLine="PD.Initialize";
_pd.Initialize();
 //BA.debugLineNum = 91;BA.debugLine="PD.Target = pnlPie 'Set the target view";
_pd.Target = mostCurrent._pnlpie;
 //BA.debugLineNum = 93;BA.debugLine="For Each k As String In datos.Keys";
final anywheresoftware.b4a.BA.IterableList group48 = _datos.Keys();
final int groupLen48 = group48.getSize();
for (int index48 = 0;index48 < groupLen48 ;index48++){
_k = BA.ObjectToString(group48.Get(index48));
 //BA.debugLineNum = 94;BA.debugLine="Charts.AddPieItem(PD, k, datos.Get(k), 0)";
mostCurrent._charts._addpieitem(mostCurrent.activityBA,_pd,_k,(float)(BA.ObjectToNumber(_datos.Get((Object)(_k)))),(int) (0));
 }
;
 //BA.debugLineNum = 97;BA.debugLine="PD.GapDegrees = 0 'Total size of gaps between sli";
_pd.GapDegrees = (int) (0);
 //BA.debugLineNum = 98;BA.debugLine="PD.LegendBackColor = Colors.ARGB(150, 100, 100, 1";
_pd.LegendBackColor = anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (150),(int) (100),(int) (100),(int) (100));
 //BA.debugLineNum = 104;BA.debugLine="legend = Charts.DrawPie(PD, Colors.Gray, True)";
mostCurrent._legend = mostCurrent._charts._drawpie(mostCurrent.activityBA,_pd,anywheresoftware.b4a.keywords.Common.Colors.Gray,anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 106;BA.debugLine="If ImageView1.IsInitialized=False Then ImageView1";
...
mostCurrent._imageview1.Initialize(mostCurrent.activityBA,"");};
 //BA.debugLineNum = 107;BA.debugLine="ImageView1.RemoveView";
mostCurrent._imageview1.RemoveView();
 //BA.debugLineNum = 108;BA.debugLine="ImageView1.SetBackgroundImage(legend)";
mostCurrent._imageview1.SetBackgroundImage((android.graphics.Bitmap)(mostCurrent._legend.getObject()));
 //BA.debugLineNum = 110;BA.debugLine="pnlPie.AddView(ImageView1, 10dip, 10dip, legend.W";
...
b4a.example.main._ingreso _objetoingreso = null;
 //BA.debugLineNum = 159;BA.debugLine="Sub ButtonIngresar_Click";
 //BA.debugLineNum = 162;BA.debugLine="If EditTextTitulo.Text.Trim=\"\" Then";
if ((mostCurrent._edittexttitulo.getText().trim()).equals("")) { 
 //BA.debugLineNum = 163;BA.debugLine="Msgbox(\"Falta ingresar el Título\",\"Error\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Falta ingresar el Título","Error",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 166;BA.debugLine="DBApp.InsertaReview(EditTextTitulo.Text,SpinnerN";
mostCurrent._dbapp._insertareview(mostCurrent.activityBA,mostCurrent._edittexttitulo.getText(),mostCurrent._spinnernota.getSelectedItem(),mostCurrent._spinnertipo.getSelectedItem());
 //BA.debugLineNum = 169;BA.debugLine="Dim ObjetoIngreso As Ingreso";
_objetoingreso = new b4a.example.main._ingreso();
 //BA.debugLineNum = 170;BA.debugLine="ObjetoIngreso.Initialize";
_objetoingreso.Initialize();
 //BA.debugLineNum = 171;BA.debugLine="ObjetoIngreso.Titulo=EditTextTitulo.Text";
_objetoingreso.Titulo = mostCurrent._edittexttitulo.getText();
 //BA.debugLineNum = 172;BA.debugLine="ObjetoIngreso.Nota=SpinnerNota.SelectedItem";
_objetoingreso.Nota = (double)(Double.parseDouble(mostCurrent._spinnernota.getSelectedItem()));
 //BA.debugLineNum = 173;BA.debugLine="ObjetoIngreso.Tipo=SpinnerTipo.SelectedItem";
_objetoingreso.Tipo = mostCurrent._spinnertipo.getSelectedItem();
 //BA.debugLineNum = 175;BA.debugLine="listaIngresos.Add(ObjetoIngreso)";
mostCurrent._listaingresos.Add((Object)(_objetoingreso));
 //BA.debugLineNum = 177;BA.debugLine="addValorGrafico(CalculaEstadistica(listaIngresos";
_addvalorgrafico(_calculaestadistica(mostCurrent._listaingresos));
 //BA.debugLineNum = 179;BA.debugLine="ListViewNotas.AddTwoLines(ObjetoIngreso.Nota, Ob";
mostCurrent._listviewnotas.AddTwoLines(BA.NumberToString(_objetoingreso.Nota),_objetoingreso.Titulo+" ("+_objetoingreso.Tipo+")");
 //BA.debugLineNum = 180;BA.debugLine="Msgbox(\"Has ingresado tu Reseña correctamente\",\"";
...
b4a.example.main._ingreso _objetoactual = null;
anywheresoftware.b4a.objects.collections.Map _mapa = null;
int _suma = 0;
int _i = 0;
int _j = 0;
 //BA.debugLineNum = 113;BA.debugLine="Sub CalculaEstadistica(lista As List) As Map";
 //BA.debugLineNum = 114;BA.debugLine="Dim ObjetoActual As Ingreso";
_objetoactual = new b4a.example.main._ingreso();
 //BA.debugLineNum = 115;BA.debugLine="Dim Mapa As Map";
_mapa = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 116;BA.debugLine="Dim suma As Int = 0";
_suma = (int) (0);
 //BA.debugLineNum = 118;BA.debugLine="For i=0 To 2";
{
final int step63 = 1;
final int limit63 = (int) (2);
for (_i = (int) (0); (step63 > 0 && _i <= limit63) || (step63 < 0 && _i >= limit63); _i = ((int)(0 + _i + step63))) {
 //BA.debugLineNum = 119;BA.debugLine="For j=0 To listaIngresos.Size-1";
{
final int step64 = 1;
final int limit64 = (int) (mostCurrent._listaingresos.getSize()-1);
for (_j = (int) (0); (step64 > 0 && _j <= limit64) || (step64 < 0 && _j >= limit64); _j = ((int)(0 + _j + step64))) {
 //BA.debugLineNum = 120;BA.debugLine="ObjetoActual=lista.Get(j)";
_objetoactual = (b4a.example.main._ingreso)(_lista.Get(_j));
 //BA.debugLineNum = 121;BA.debugLine="Select i";
switch (BA.switchObjectToInt(_i,(int)(Double.parseDouble("0")),(int)(Double.parseDouble("1")),(int)(Double.parseDouble("2")))) {
case 0:
 //BA.debugLineNum = 123;BA.debugLine="If ObjetoActual.Tipo=\"Solo Título\" Then";
if ((_objetoactual.Tipo).equals("Solo Título")) { 
 //BA.debugLineNum = 124;BA.debugLine="suma=suma+1";
_suma = (int) (_suma+1);
 };
 break;
case 1:
 //BA.debugLineNum = 128;BA.debugLine="If ObjetoActual.Tipo=\"Texto\" Then";
if ((_objetoactual.Tipo).equals("Texto")) { 
 //BA.debugLineNum = 129;BA.debugLine="suma=suma+1";
_suma = (int) (_suma+1);
 };
 break;
case 2:
 //BA.debugLineNum = 133;BA.debugLine="If ObjetoActual.Tipo=\"Voz\" Then";
if ((_objetoactual.Tipo).equals("Voz")) { 
 //BA.debugLineNum = 134;BA.debugLine="suma=suma+1";
_suma = (int) (_suma+1);
 };
 break;
}
;
 ...
 //BA.debugLineNum = 140;BA.debugLine="If Mapa.IsInitialized=False Then Mapa.Initialize";
if (_mapa.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
_mapa.Initialize();};
 //BA.debugLineNum = 141;BA.debugLine="If i=0 Then Mapa.Put(\"Solo Título\",suma)";
if (_i==0) { 
_mapa.Put((Object)("Solo Título"),(Object)(_suma));};
 //BA.debugLineNum = 142;BA.debugLine="If i=1 Then Mapa.Put(\"Texto\",suma)";
if (_i==1) { 
_mapa.Put((Object)("Texto"),(Object)(_suma));};
 //BA.debugLineNum = 143;BA.debugLine="If i=2 Then Mapa.Put(\"Voz\",suma)";
if (_i==2) { 
_mapa.Put((Object)("Voz"),(Object)(_suma));};
 //BA.debugLineNum = 145;BA.debugLine="suma=0";
_suma = (int) (0);
 }
};
 //BA.debugLineNum = 148;BA.debugLine="Return Mapa";
...
public static String  _gesture_onfling(float _velocityx,float _velocityy,Object _motionevent1,Object _motionevent2) throws Exception{
 //BA.debugLineNum = 185;BA.debugLine="Sub Gesture_onFling(velocityX As Float, velocityY";
 //BA.debugLineNum = 186;BA.debugLine="Log(\"   onFling velocityX = \" & velocityX & \", ve";
anywheresoftware.b4a.keywords.Common.Log("   onFling velocityX = "+BA.NumberToString(_velocityx)+", velocityY = "+BA.NumberToString(_velocityy)+", ev1 = "+BA.ObjectToString(_motionevent1)+", ev2 = "+BA.ObjectToString(_motionevent2));
 //BA.debugLineNum = 187;BA.debugLine="If velocityX<0 Then";
if (_velocityx<0) { 
 //BA.debugLineNum = 188;BA.debugLine="TabHost1.CurrentTab=(TabHost1.CurrentTab+1) Mod";
mostCurrent._tabhost1.setCurrentTab((int) ((mostCurrent._tabhost1.getCurrentTab()+1)%mostCurrent._tabhost1.getTabCount()));
 }else {
 //BA.debugLineNum = 190;BA.debugLine="If TabHost1.CurrentTab=0 Then";
if (mostCurrent._tabhost1.getCurrentTab()==0) { 
 //BA.debugLineNum = 191;BA.debugLine="TabHost1.CurrentTab=TabHost1.TabCount-1";
mostCurrent._tabhost1.setCurrentTab((int) (mostCurrent._tabhost1.getTabCount()-1));
 }else {
 //BA.debugLineNum = 193;BA.debugLine="TabHost1.CurrentTab=(TabHost1.CurrentTab-1) Mod";
mostCurrent._tabhost1.setCurrentTab((int) ((mostCurrent._tabhost1.getCurrentTab()-1)%mostCurrent._tabhost1.getTabCount()));
 };
 };
...
double _i = 0;
 //BA.debugLineNum = 151;BA.debugLine="Sub LLenaSpinnerNota";
 //BA.debugLineNum = 152;BA.debugLine="Dim I As Double=7.0";
_i = 7.0;
 //BA.debugLineNum = 153;BA.debugLine="Do While I>=1.0";
while (_i>=1.0) {
 //BA.debugLineNum = 154;BA.debugLine="SpinnerNota.add(Round2(I,1))";
mostCurrent._spinnernota.Add(BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round2(_i,(int) (1))));
 //BA.debugLineNum = 155;BA.debugLine="I=I-0.1";
_i = _i-0.1;
 }
;
...
anywheresoftware.b4a.objects.PanelWrapper _p = null;
 //BA.debugLineNum = 78;BA.debugLine="Sub TabGraficoPie";
 //BA.debugLineNum = 79;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 80;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 81;BA.debugLine="pnlPie.Initialize(\"pnlPie\")";
mostCurrent._pnlpie.Initialize(mostCurrent.activityBA,"pnlPie");
 //BA.debugLineNum = 82;BA.debugLine="p.AddView(pnlPie, 0, 0, 100%x, 100%y - 100dip)";
_p.AddView((android.view.View)(mostCurrent._pnlpie.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),(int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100))));
 //BA.debugLineNum = 83;BA.debugLine="TabHost1.AddTab2(\"Resumen\", p)";

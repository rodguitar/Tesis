...
mostCurrent._dbapp._creabd(mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 60;BA.debugLine="GD.SetOnGestureListener(Activity, \"Gesture\")";
mostCurrent._gd.SetOnGestureListener(processBA,(android.view.View)(mostCurrent._activity.getObject()),"Gesture");
 //BA.debugLineNum = 62;BA.debugLine="TabHost1.Initialize(\"TabHost1\")";
mostCurrent._tabhost1.Initialize(mostCurrent.activityBA,"TabHost1");
 //BA.debugLineNum = 65;BA.debugLine="Activity.AddView(TabHost1, 0, 0, 100%x, 100%y)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._tabhost1.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 66;BA.debugLine="TabHost1.AddTab(\"Ingreso de Reseñas\",\"Layout1\")";
mostCurrent._tabhost1.AddTab(mostCurrent.activityBA,"Ingreso de Reseñas","Layout1");
 //BA.debugLineNum = 67;BA.debugLine="Activity.Title=\"Desafío 1\"";
mostCurrent._activity.setTitle((Object)("Desafío 1"));
 //BA.debugLineNum = 69;BA.debugLine="LLenaSpinnerNota";
_llenaspinnernota();
 //BA.debugLineNum = 70;BA.debugLine="SpinnerTipo.Add(\"Solo Título\")";
mostCurrent._spinnertipo.Add("Solo Título");
 //BA.debugLineNum = 71;BA.debugLine="SpinnerTipo.Add(\"Texto\")";
mostCurrent._spinnertipo.Add("Texto");
 //BA.debugLineNum = 72;BA.debugLine="SpinnerTipo.Add(\"Voz\")";
mostCurrent._spinnertipo.Add("Voz");
 //BA.debugLineNum = 74;BA.debugLine="LLenaListview";
_llenalistview();
 //BA.debugLineNum = 76;BA.debugLine="TabGraficoPie";
_tabgraficopie();
 //BA.debugLineNum = 77;BA.debugLine="addValorGrafico(CalculaEstadistica)";
_addvalorgrafico(_calculaestadistica());
 //BA.debugLineNum = 78;BA.debugLine="TabBuscar";
_tabbuscar();
 //BA.debugLineNum = 80;BA.debugLine="Mi_acelerometro.StartListening(\"Sensor\")";
_mi_acelerometro.StartListening(processBA,"Sensor");
 //BA.debugLineNum = 81;BA.debugLine="RelojAcelerometro.Initialize(\"Intervalo\",100)";
_relojacelerometro.Initialize(processBA,"Intervalo",(long) (100));
 //BA.debugLineNum = 82;BA.debugLine="RelojAcelerometro.Enabled=True";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 91;BA.debugLine="Mi_acelerometro.StopListening";
_mi_acelerometro.StopListening(processBA);
 //BA.debugLineNum = 92;BA.debugLine="RelojAcelerometro.Enabled=False";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 86;BA.debugLine="Mi_acelerometro.StartListening(\"Sensor\")";
_mi_acelerometro.StartListening(processBA,"Sensor");
 //BA.debugLineNum = 87;BA.debugLine="RelojAcelerometro.Enabled=True";
_relojacelerometro.setEnabled(anywheresoftware.b4a.keywords.Common.True);
...
String _k = "";
 //BA.debugLineNum = 109;BA.debugLine="Sub addValorGrafico(datos As Map)";
 //BA.debugLineNum = 111;BA.debugLine="Dim PD As PieData";
_pd = new b4a.example.charts._piedata();
 //BA.debugLineNum = 112;BA.debugLine="PD.Initialize";
_pd.Initialize();
 //BA.debugLineNum = 113;BA.debugLine="PD.Target = pnlPie 'Set the target view";
_pd.Target = mostCurrent._pnlpie;
 //BA.debugLineNum = 115;BA.debugLine="For Each k As String In datos.Keys";
final anywheresoftware.b4a.BA.IterableList group65 = _datos.Keys();
final int groupLen65 = group65.getSize();
for (int index65 = 0;index65 < groupLen65 ;index65++){
_k = BA.ObjectToString(group65.Get(index65));
 //BA.debugLineNum = 116;BA.debugLine="Charts.AddPieItem(PD, k, datos.Get(k), 0)";
mostCurrent._charts._addpieitem(mostCurrent.activityBA,_pd,_k,(float)(BA.ObjectToNumber(_datos.Get((Object)(_k)))),(int) (0));
 }
;
 //BA.debugLineNum = 119;BA.debugLine="PD.GapDegrees = 0 'Total size of gaps between slices. Set to 0 for no gaps.";
_pd.GapDegrees = (int) (0);
 //BA.debugLineNum = 120;BA.debugLine="PD.LegendBackColor = Colors.ARGB(150, 100, 100, 100) 'The background color of the legend bitmap.";
_pd.LegendBackColor = anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (150),(int) (100),(int) (100),(int) (100));
 //BA.debugLineNum = 126;BA.debugLine="legend = Charts.DrawPie(PD, Colors.Gray, True)";
mostCurrent._legend = mostCurrent._charts._drawpie(mostCurrent.activityBA,_pd,anywheresoftware.b4a.keywords.Common.Colors.Gray,anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 128;BA.debugLine="If ImageView1.IsInitialized=False Then ImageView1.Initialize(\"\")";
...
mostCurrent._imageview1.Initialize(mostCurrent.activityBA,"");};
 //BA.debugLineNum = 129;BA.debugLine="ImageView1.RemoveView";
mostCurrent._imageview1.RemoveView();
 //BA.debugLineNum = 130;BA.debugLine="ImageView1.SetBackgroundImage(legend)";
mostCurrent._imageview1.SetBackgroundImage((android.graphics.Bitmap)(mostCurrent._legend.getObject()));
 //BA.debugLineNum = 132;BA.debugLine="pnlPie.AddView(ImageView1, 10dip, 10dip, legend.Width, legend.Height)";
...
public static String  _buttoningresar_click() throws Exception{
 //BA.debugLineNum = 205;BA.debugLine="Sub ButtonIngresar_Click";
 //BA.debugLineNum = 208;BA.debugLine="If EditTextTitulo.Text.Trim=\"\" Then";
if ((mostCurrent._edittexttitulo.getText().trim()).equals("")) { 
 //BA.debugLineNum = 209;BA.debugLine="Msgbox(\"Falta ingresar el Título\",\"Error\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Falta ingresar el Título","Error",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 213;BA.debugLine="DBApp.InsertaReview(EditTextTitulo.Text,SpinnerNota.SelectedItem,SpinnerTipo.SelectedItem)";
mostCurrent._dbapp._insertareview(mostCurrent.activityBA,mostCurrent._edittexttitulo.getText(),mostCurrent._spinnernota.getSelectedItem(),mostCurrent._spinnertipo.getSelectedItem());
 //BA.debugLineNum = 215;BA.debugLine="LLenaListview";
_llenalistview();
 //BA.debugLineNum = 217;BA.debugLine="addValorGrafico(CalculaEstadistica)";
_addvalorgrafico(_calculaestadistica());
 //BA.debugLineNum = 219;BA.debugLine="Msgbox(\"Has ingresado tu Reseña correctamente\",\"Exito\")";
...
int _sumav = 0;
int _i = 0;
 //BA.debugLineNum = 135;BA.debugLine="Sub CalculaEstadistica As Map";
 //BA.debugLineNum = 137;BA.debugLine="Dim Mapa As Map";
_mapa = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 138;BA.debugLine="Dim sumaST As Int";
_sumast = 0;
 //BA.debugLineNum = 139;BA.debugLine="Dim sumaT As Int";
_sumat = 0;
 //BA.debugLineNum = 140;BA.debugLine="Dim sumaV As Int";
_sumav = 0;
 //BA.debugLineNum = 142;BA.debugLine="If Mi_Cursor.RowCount>0 Then";
if (mostCurrent._mi_cursor.getRowCount()>0) { 
 //BA.debugLineNum = 144;BA.debugLine="For i=0 To Mi_Cursor.RowCount-1";
{
final int step82 = 1;
final int limit82 = (int) (mostCurrent._mi_cursor.getRowCount()-1);
for (_i = (int) (0); (step82 > 0 && _i <= limit82) || (step82 < 0 && _i >= limit82); _i = ((int)(0 + _i + step82))) {
 //BA.debugLineNum = 146;BA.debugLine="Mi_Cursor.Position=i";
mostCurrent._mi_cursor.setPosition(_i);
 //BA.debugLineNum = 148;BA.debugLine="Select Mi_Cursor.GetString(\"tipo\")";
switch (BA.switchObjectToInt(mostCurrent._mi_cursor.GetString("tipo"),"Solo Título","Texto","Voz")) {
case 0:
 //BA.debugLineNum = 151;BA.debugLine="sumaST=sumaST+1";
_sumast = (int) (_sumast+1);
 break;
case 1:
 //BA.debugLineNum = 154;BA.debugLine="sumaT=sumaT+1";
_sumat = (int) (_sumat+1);
 break;
case 2:
 //BA.debugLineNum = 157;BA.debugLine="sumaV=sumaV+1";
_sumav = (int) (_sumav+1);
 break;
}
;
 ...
 //BA.debugLineNum = 165;BA.debugLine="If Mapa.IsInitialized=False Then Mapa.Initialize";
if (_mapa.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
_mapa.Initialize();};
 //BA.debugLineNum = 166;BA.debugLine="Mapa.Put(\"Solo Título\",sumaST)";
_mapa.Put((Object)("Solo Título"),(Object)(_sumast));
 //BA.debugLineNum = 167;BA.debugLine="Mapa.Put(\"Texto\",sumaT)";
_mapa.Put((Object)("Texto"),(Object)(_sumat));
 //BA.debugLineNum = 168;BA.debugLine="Mapa.Put(\"Voz\",sumaV)";
_mapa.Put((Object)("Voz"),(Object)(_sumav));
 //BA.debugLineNum = 170;BA.debugLine="sumaST = 0";
_sumast = (int) (0);
 //BA.debugLineNum = 171;BA.debugLine="sumaT = 0";
_sumat = (int) (0);
 //BA.debugLineNum = 172;BA.debugLine="sumaV = 0";
_sumav = (int) (0);
 //BA.debugLineNum = 174;BA.debugLine="Return Mapa";
...
int _i = 0;
 //BA.debugLineNum = 239;BA.debugLine="Sub EditTextBusca_TextChanged (Old As String, New As String)";
 //BA.debugLineNum = 241;BA.debugLine="Mi_CursorBusca=DBApp.Mi_BD.ExecQuery(\"SELECT id_review, titulo, nota, tipo FROM REVIEW WHERE titulo LIKE '\"& New &\"%' \")";
mostCurrent._mi_cursorbusca.setObject((android.database.Cursor)(mostCurrent._dbapp._mi_bd.ExecQuery("SELECT id_review, titulo, nota, tipo FROM REVIEW WHERE titulo LIKE '"+_new+"%' ")));
 //BA.debugLineNum = 243;BA.debugLine="ListViewResultados.Clear";
mostCurrent._listviewresultados.Clear();
 //BA.debugLineNum = 245;BA.debugLine="If Mi_CursorBusca.RowCount>0 Then";
if (mostCurrent._mi_cursorbusca.getRowCount()>0) { 
 //BA.debugLineNum = 247;BA.debugLine="For i=0 To Mi_CursorBusca.RowCount-1";
{
final int step147 = 1;
final int limit147 = (int) (mostCurrent._mi_cursorbusca.getRowCount()-1);
for (_i = (int) (0); (step147 > 0 && _i <= limit147) || (step147 < 0 && _i >= limit147); _i = ((int)(0 + _i + step147))) {
 //BA.debugLineNum = 249;BA.debugLine="Mi_CursorBusca.Position=i";
mostCurrent._mi_cursorbusca.setPosition(_i);
 //BA.debugLineNum = 250;BA.debugLine="ListViewResultados.AddTwoLines(Mi_CursorBusca.GetString(\"id_review\"),Mi_CursorBusca.GetString(\"titulo\") & \" (\"&Mi_CursorBusca.GetString(\"nota\")&\", \"& Mi_CursorBusca.GetString(\"tipo\") &\")\")";
...
public static String  _gesture_onfling(float _velocityx,float _velocityy,Object _motionevent1,Object _motionevent2) throws Exception{
 //BA.debugLineNum = 224;BA.debugLine="Sub Gesture_onFling(velocityX As Float, velocityY As Float, MotionEvent1 As Object, MotionEvent2 As Object)";
 //BA.debugLineNum = 225;BA.debugLine="Log(\"   onFling velocityX = \" & velocityX & \", velocityY = \" & velocityY & \", ev1 = \" & MotionEvent1 & \", ev2 = \" & MotionEvent2)";
anywheresoftware.b4a.keywords.Common.Log("   onFling velocityX = "+BA.NumberToString(_velocityx)+", velocityY = "+BA.NumberToString(_velocityy)+", ev1 = "+BA.ObjectToString(_motionevent1)+", ev2 = "+BA.ObjectToString(_motionevent2));
 //BA.debugLineNum = 226;BA.debugLine="If velocityX<0 Then";
if (_velocityx<0) { 
 //BA.debugLineNum = 227;BA.debugLine="TabHost1.CurrentTab=(TabHost1.CurrentTab+1) Mod TabHost1.TabCount";
mostCurrent._tabhost1.setCurrentTab((int) ((mostCurrent._tabhost1.getCurrentTab()+1)%mostCurrent._tabhost1.getTabCount()));
 }else {
 //BA.debugLineNum = 229;BA.debugLine="If TabHost1.CurrentTab=0 Then";
if (mostCurrent._tabhost1.getCurrentTab()==0) { 
 //BA.debugLineNum = 230;BA.debugLine="TabHost1.CurrentTab=TabHost1.TabCount-1";
mostCurrent._tabhost1.setCurrentTab((int) (mostCurrent._tabhost1.getTabCount()-1));
 }else {
 //BA.debugLineNum = 232;BA.debugLine="TabHost1.CurrentTab=(TabHost1.CurrentTab-1) Mod TabHost1.TabCount";
mostCurrent._tabhost1.setCurrentTab((int) ((mostCurrent._tabhost1.getCurrentTab()-1)%mostCurrent._tabhost1.getTabCount()));
 };
 };
...
dbapp._process_globals();
 ...
 //BA.debugLineNum = 29;BA.debugLine="Dim GD As GestureDetector";
mostCurrent._gd = new flm.b4a.gesturedetector.GestureDetectorForB4A();
 //BA.debugLineNum = 30;BA.debugLine="Dim pnlPie As Panel";
...
mostCurrent._tabhost1 = new anywheresoftware.b4a.objects.TabHostWrapper();
 //BA.debugLineNum = 33;BA.debugLine="Dim ImageView1 As ImageView";
mostCurrent._imageview1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 34;BA.debugLine="Dim legend As Bitmap";
mostCurrent._legend = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 36;BA.debugLine="Private SpinnerNota As Spinner";
mostCurrent._spinnernota = new anywheresoftware.b4a.objects.SpinnerWrapper();
 //BA.debugLineNum = 37;BA.debugLine="Private ListViewNotas As ListView";
...
mostCurrent._spinnertipo = new anywheresoftware.b4a.objects.SpinnerWrapper();
 //BA.debugLineNum = 43;BA.debugLine="Dim Mi_Cursor As Cursor' cursor para almacenar y recorrer una respuesta de un SELECT";
mostCurrent._mi_cursor = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 44;BA.debugLine="Dim Mi_CursorBusca As Cursor";
mostCurrent._mi_cursorbusca = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 45;BA.debugLine="Private EditTextBusca As EditText";
mostCurrent._edittextbusca = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 46;BA.debugLine="Private ListViewResultados As ListView";
mostCurrent._listviewresultados = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 51;BA.debugLine="Dim PAUSA As Boolean";
_pausa = false;
...
int _ret = 0;
 //BA.debugLineNum = 278;BA.debugLine="Sub InputDialogTitulo(posicion As Int)";
 //BA.debugLineNum = 279;BA.debugLine="Dim Id As InputDialog";
_id = new anywheresoftware.b4a.agraham.dialogs.InputDialog();
 //BA.debugLineNum = 280;BA.debugLine="Id.Hint = \"Escribe Aquí\"";
_id.setHint("Escribe Aquí");
 //BA.debugLineNum = 281;BA.debugLine="Id.HintColor = Colors.ARGB(196, 255, 140, 0)";
_id.setHintColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (196),(int) (255),(int) (140),(int) (0)));
 //BA.debugLineNum = 283;BA.debugLine="Dim ret As Int = Id.Show(\"Escribe el Título Nuevo\", \"Edita Título\", \"Cambiar\", \"Cancelar\",\"\", Null)";
_ret = _id.Show("Escribe el Título Nuevo","Edita Título","Cambiar","Cancelar","",mostCurrent.activityBA,(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 285;BA.debugLine="If ret = -1 Then";
if (_ret==-1) { 
 //BA.debugLineNum = 286;BA.debugLine="DBApp.EditaReview(Id.Input,posicion)";
mostCurrent._dbapp._editareview(mostCurrent.activityBA,_id.getInput(),BA.NumberToString(_posicion));
 };
 //BA.debugLineNum = 290;BA.debugLine="If ret = -3 Then";
if (_ret==-3) { 
 };
...
public static String  _intervalo_tick() throws Exception{
 //BA.debugLineNum = 317;BA.debugLine="Sub Intervalo_Tick";
 //BA.debugLineNum = 318;BA.debugLine="PAUSA=True";
_pausa = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 319;BA.debugLine="RelojAcelerometro.Interval=100";
...
int _mensaje = 0;
 //BA.debugLineNum = 257;BA.debugLine="Sub ListViewResultados_ItemLongClick (Position As Int, Value As Object)";
 //BA.debugLineNum = 259;BA.debugLine="Dim mensaje As Int";
_mensaje = 0;
 //BA.debugLineNum = 260;BA.debugLine="mensaje = Msgbox2(\"Opciones\",\"\",\"Editar\",\"Cancelar\",\"Eliminar\",Null)";
_mensaje = anywheresoftware.b4a.keywords.Common.Msgbox2("Opciones","","Editar","Cancelar","Eliminar",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
 //BA.debugLineNum = 261;BA.debugLine="Select mensaje";
...
case 0:
 //BA.debugLineNum = 263;BA.debugLine="Log(\"Se pulsó Editar\")";
anywheresoftware.b4a.keywords.Common.Log("Se pulsó Editar");
 //BA.debugLineNum = 265;BA.debugLine="InputDialogTitulo(ListViewResultados.GetItem(Position))";
_inputdialogtitulo((int)(BA.ObjectToNumber(mostCurrent._listviewresultados.GetItem(_position))));
 break;
case 1:
 //BA.debugLineNum = 268;BA.debugLine="DBApp.EliminaReview(ListViewResultados.GetItem(Position))";
mostCurrent._dbapp._eliminareview(mostCurrent.activityBA,BA.ObjectToString(mostCurrent._listviewresultados.GetItem(_position)));
 break;
case 2:
 //BA.debugLineNum = 271;BA.debugLine="Log(\"Se pulsó Cancelar\")";
...
int _i = 0;
 //BA.debugLineNum = 185;BA.debugLine="Sub LLenaListview";
 //BA.debugLineNum = 187;BA.debugLine="Mi_Cursor=DBApp.Mi_BD.ExecQuery(\"SELECT titulo, nota, tipo FROM REVIEW\")";
mostCurrent._mi_cursor.setObject((android.database.Cursor)(mostCurrent._dbapp._mi_bd.ExecQuery("SELECT titulo, nota, tipo FROM REVIEW")));
 //BA.debugLineNum = 189;BA.debugLine="ListViewNotas.Clear";
mostCurrent._listviewnotas.Clear();
 //BA.debugLineNum = 190;BA.debugLine="EditTextTitulo.Text=\"\"";
mostCurrent._edittexttitulo.setText((Object)(""));
 //BA.debugLineNum = 192;BA.debugLine="If Mi_Cursor.RowCount>0 Then";
if (mostCurrent._mi_cursor.getRowCount()>0) { 
 //BA.debugLineNum = 194;BA.debugLine="For i=0 To Mi_Cursor.RowCount-1";
{
final int step115 = 1;
...
for (_i = (int) (0); (step115 > 0 && _i <= limit115) || (step115 < 0 && _i >= limit115); _i = ((int)(0 + _i + step115))) {
 //BA.debugLineNum = 196;BA.debugLine="Mi_Cursor.Position=i";
mostCurrent._mi_cursor.setPosition(_i);
 //BA.debugLineNum = 197;BA.debugLine="ListViewNotas.AddTwoLines(Mi_Cursor.GetString(\"nota\"),Mi_Cursor.GetString(\"titulo\") & \" (\"& Mi_Cursor.GetString(\"tipo\") &\")\")";
...
double _i = 0;
 //BA.debugLineNum = 177;BA.debugLine="Sub LLenaSpinnerNota";
 //BA.debugLineNum = 178;BA.debugLine="Dim I As Double=7.0";
_i = 7.0;
 //BA.debugLineNum = 179;BA.debugLine="Do While I>=1.0";
while (_i>=1.0) {
 //BA.debugLineNum = 180;BA.debugLine="SpinnerNota.add(Round2(I,1))";
mostCurrent._spinnernota.Add(BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round2(_i,(int) (1))));
 //BA.debugLineNum = 181;BA.debugLine="I=I-0.1";
_i = _i-0.1;
 }
;
...
public static String  _sensor_accelerometerchanged(float _x,float _y,float _z) throws Exception{
 //BA.debugLineNum = 295;BA.debugLine="Sub Sensor_AccelerometerChanged (X As Float, Y As Float, Z As Float)";
 //BA.debugLineNum = 297;BA.debugLine="If PAUSA= True Then";
if (_pausa==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 298;BA.debugLine="If X>11 Then";
if (_x>11) { 
 //BA.debugLineNum = 299;BA.debugLine="TabHost1.CurrentTab=(TabHost1.CurrentTab+1) Mod TabHost1.TabCount";
mostCurrent._tabhost1.setCurrentTab((int) ((mostCurrent._tabhost1.getCurrentTab()+1)%mostCurrent._tabhost1.getTabCount()));
 //BA.debugLineNum = 300;BA.debugLine="RelojAcelerometro.Interval=1000";
_relojacelerometro.setInterval((long) (1000));
 }else {
 //BA.debugLineNum = 302;BA.debugLine="If Y>11 Then";
if (_y>11) { 
 //BA.debugLineNum = 303;BA.debugLine="TabHost1.CurrentTab=(TabHost1.CurrentTab+1) Mod TabHost1.TabCount";
mostCurrent._tabhost1.setCurrentTab((int) ((mostCurrent._tabhost1.getCurrentTab()+1)%mostCurrent._tabhost1.getTabCount()));
 //BA.debugLineNum = 304;BA.debugLine="RelojAcelerometro.Interval=1000";
_relojacelerometro.setInterval((long) (1000));
 }else {
 //BA.debugLineNum = 306;BA.debugLine="If Z>11 Then";
if (_z>11) { 
 //BA.debugLineNum = 307;BA.debugLine="TabHost1.CurrentTab=(TabHost1.CurrentTab+1) Mod TabHost1.TabCount";
mostCurrent._tabhost1.setCurrentTab((int) ((mostCurrent._tabhost1.getCurrentTab()+1)%mostCurrent._tabhost1.getTabCount()));
 //BA.debugLineNum = 308;BA.debugLine="RelojAcelerometro.Interval=1000";
_relojacelerometro.setInterval((long) (1000));
 };
 };
 };
 };
 //BA.debugLineNum = 314;BA.debugLine="PAUSA=False";
_pausa = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 315;BA.debugLine="End Sub";
return "";
}
public static String  _tabbuscar() throws Exception{
 //BA.debugLineNum = 105;BA.debugLine="Sub TabBuscar";
 //BA.debugLineNum = 106;BA.debugLine="TabHost1.AddTab(\"Buscador\",\"layoutBusca\")";
...
anywheresoftware.b4a.objects.PanelWrapper _p = null;
 //BA.debugLineNum = 96;BA.debugLine="Sub TabGraficoPie";
 //BA.debugLineNum = 97;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 98;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 99;BA.debugLine="pnlPie.Initialize(\"pnlPie\")";
mostCurrent._pnlpie.Initialize(mostCurrent.activityBA,"pnlPie");
 //BA.debugLineNum = 100;BA.debugLine="p.AddView(pnlPie, 0, 0, 100%x, 100%y - 100dip)";
_p.AddView((android.view.View)(mostCurrent._pnlpie.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),(int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100))));
 //BA.debugLineNum = 101;BA.debugLine="TabHost1.AddTab2(\"Resumen\", p)";

...
_ssql = _ssql+"tipo TEXT, ";
 //BA.debugLineNum = 20;BA.debugLine="sSql = sSql & \"fecha_registro TIMESTAMP DEFAULT CURRENT_TIMESTAMP)\"";
...
_mi_bd.ExecNonQuery(_ssql);
			...
			(_ba.processBA == null ? _ba : _ba.processBA).setLastException(e15); //BA.debugLineNum = 23;BA.debugLine="Log(\"catch ERROR CREATE TABLE IF NOT EXISTS REVIEW: \"&LastException.Message)";
...
try { //BA.debugLineNum = 45;BA.debugLine="Mi_BD.ExecNonQuery(\"UPDATE REVIEW SET titulo='\"& titulo &\"' WHERE id_review='\"& id_review &\"'\")";
_mi_bd.ExecNonQuery("UPDATE REVIEW SET titulo='"+_titulo+"' WHERE id_review='"+_id_review+"'");
 //BA.debugLineNum = 46;BA.debugLine="Log(\"OK UPDATE de UpLibretaConductor en libreta Realizado.\")";
anywheresoftware.b4a.keywords.Common.Log("OK UPDATE de UpLibretaConductor en libreta Realizado.");
 } 
       catch (Exception e36) {
			(_ba.processBA == null ? _ba : _ba.processBA).setLastException(e36); //BA.debugLineNum = 49;BA.debugLine="Log(\"catch UPDATE de UpLibretaConductor en libreta  DBApp   \" & LastException.Message)";
anywheresoftware.b4a.keywords.Common.Log("catch UPDATE de UpLibretaConductor en libreta  DBApp   "+anywheresoftware.b4a.keywords.Common.LastException(_ba).getMessage());
 };
...
try { //BA.debugLineNum = 57;BA.debugLine="Mi_BD.ExecNonQuery(\"DELETE from REVIEW where id_review= '\"& id_review &\"' \")";
_mi_bd.ExecNonQuery("DELETE from REVIEW where id_review= '"+_id_review+"' ");
 //BA.debugLineNum = 58;BA.debugLine="Log(\"OK UPDATE de UpLibretaConductor en libreta Realizado.\")";
anywheresoftware.b4a.keywords.Common.Log("OK UPDATE de UpLibretaConductor en libreta Realizado.");
 } 
       catch (Exception e44) {
			(_ba.processBA == null ? _ba : _ba.processBA).setLastException(e44); //BA.debugLineNum = 61;BA.debugLine="Log(\"catch UPDATE de UpLibretaConductor en libreta  DBApp   \" & LastException.Message)";
anywheresoftware.b4a.keywords.Common.Log("catch UPDATE de UpLibretaConductor en libreta  DBApp   "+anywheresoftware.b4a.keywords.Common.LastException(_ba).getMessage());
 };
...
String _fecha = "";
 //BA.debugLineNum = 28;BA.debugLine="Sub InsertaReview(titulo As String, nota As String, tipo As String)";
 //BA.debugLineNum = 29;BA.debugLine="Dim fecha As String";
_fecha = "";
 //BA.debugLineNum = 30;BA.debugLine="Try";
try { //BA.debugLineNum = 31;BA.debugLine="fecha=Mi_BD.ExecQuerySingleResult(\"SELECT datetime(CURRENT_TIMESTAMP,'localtime')\")";
_fecha = _mi_bd.ExecQuerySingleResult("SELECT datetime(CURRENT_TIMESTAMP,'localtime')");
 } 
       catch (Exception e23) {
			(_ba.processBA == null ? _ba : _ba.processBA).setLastException(e23); //BA.debugLineNum = 33;BA.debugLine="Log(\"catch ERROR INSERT INTO REVIEW: \"&LastException.Message)";
...
try { //BA.debugLineNum = 37;BA.debugLine="Mi_BD.ExecNonQuery2(\"INSERT INTO REVIEW (titulo,nota,tipo,fecha_registro) VALUES (?,?,?,'\"&fecha&\"')\", Array As Object(titulo,nota,tipo))";
_mi_bd.ExecNonQuery2("INSERT INTO REVIEW (titulo,nota,tipo,fecha_registro) VALUES (?,?,?,'"+_fecha+"')",anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(_titulo),(Object)(_nota),(Object)(_tipo)}));
			...
			(_ba.processBA == null ? _ba : _ba.processBA).setLastException(e28); //BA.debugLineNum = 39;BA.debugLine="Log(\"catch ERROR INSERT INTO REVIEW: \"&LastException.Message)";
anywheresoftware.b4a.keywords.Common.Log("catch ERROR INSERT INTO REVIEW: "+anywheresoftware.b4a.keywords.Common.LastException(_ba).getMessage());
 };

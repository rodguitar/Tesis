...
public anywheresoftware.b4a.objects.LabelWrapper _labelacelerometro = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 51;BA.debugLine="If FirstTime=True Then";
if (_firsttime==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 52;BA.debugLine="DBApp.CreaBD";
mostCurrent._dbapp._creabd(mostCurrent.activityBA);
 };
 //BA.debugLineNum = 54;BA.debugLine="GD.SetOnGestureListener(Activity, \"Gesture\")";
mostCurrent._gd.SetOnGestureListener(processBA,(android.view.View)(mostCurrent._activity.getObject()),"Gesture");
 //BA.debugLineNum = 56;BA.debugLine="TabHost1.Initialize(\"TabHost1\")";
mostCurrent._tabhost1.Initialize(mostCurrent.activityBA,"TabHost1");
 //BA.debugLineNum = 59;BA.debugLine="Activity.AddView(TabHost1, 0, 0, 100%x, 100%y)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._tabhost1.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 60;BA.debugLine="TabHost1.AddTab(\"Ingreso de Reseñas\",\"Layout1\")";
mostCurrent._tabhost1.AddTab(mostCurrent.activityBA,"Ingreso de Reseñas","Layout1");
 //BA.debugLineNum = 61;BA.debugLine="Activity.Title=\"Desafío 1\"";
mostCurrent._activity.setTitle((Object)("Desafío 1"));
 //BA.debugLineNum = 63;BA.debugLine="LLenaSpinnerNota";
_llenaspinnernota();
 //BA.debugLineNum = 64;BA.debugLine="SpinnerTipo.Add(\"Solo Título\")";
mostCurrent._spinnertipo.Add("Solo Título");
 //BA.debugLineNum = 65;BA.debugLine="SpinnerTipo.Add(\"Texto\")";
mostCurrent._spinnertipo.Add("Texto");
 //BA.debugLineNum = 66;BA.debugLine="SpinnerTipo.Add(\"Voz\")";
mostCurrent._spinnertipo.Add("Voz");
 //BA.debugLineNum = 68;BA.debugLine="LLenaListview";
_llenalistview();
 //BA.debugLineNum = 70;BA.debugLine="TabGraficoPie";
_tabgraficopie();
 //BA.debugLineNum = 71;BA.debugLine="addValorGrafico(CalculaEstadistica)";
_addvalorgrafico(_calculaestadistica());
 //BA.debugLineNum = 72;BA.debugLine="TabBuscar";
_tabbuscar();
 //BA.debugLineNum = 74;BA.debugLine="Mi_acelerometro.StartListening(\"Sensor\")";
...
String _k = "";
 //BA.debugLineNum = 99;BA.debugLine="Sub addValorGrafico(datos As Map)";
 //BA.debugLineNum = 101;BA.debugLine="Dim PD As PieData";
_pd = new b4a.example.charts._piedata();
 //BA.debugLineNum = 102;BA.debugLine="PD.Initialize";
_pd.Initialize();
 //BA.debugLineNum = 103;BA.debugLine="PD.Target = pnlPie 'Set the target view";
_pd.Target = mostCurrent._pnlpie;
 //BA.debugLineNum = 105;BA.debugLine="For Each k As String In datos.Keys";
final anywheresoftware.b4a.BA.IterableList group58 = _datos.Keys();
final int groupLen58 = group58.getSize();
for (int index58 = 0;index58 < groupLen58 ;index58++){
_k = BA.ObjectToString(group58.Get(index58));
 //BA.debugLineNum = 106;BA.debugLine="Charts.AddPieItem(PD, k, datos.Get(k), 0)";
mostCurrent._charts._addpieitem(mostCurrent.activityBA,_pd,_k,(float)(BA.ObjectToNumber(_datos.Get((Object)(_k)))),(int) (0));
 }
;
 //BA.debugLineNum = 109;BA.debugLine="PD.GapDegrees = 0 'Total size of gaps between slices. Set to 0 for no gaps.";
_pd.GapDegrees = (int) (0);
 //BA.debugLineNum = 110;BA.debugLine="PD.LegendBackColor = Colors.ARGB(150, 100, 100, 100) 'The background color of the legend bitmap.";
_pd.LegendBackColor = anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (150),(int) (100),(int) (100),(int) (100));
 //BA.debugLineNum = 116;BA.debugLine="legend = Charts.DrawPie(PD, Colors.Gray, True)";
mostCurrent._legend = mostCurrent._charts._drawpie(mostCurrent.activityBA,_pd,anywheresoftware.b4a.keywords.Common.Colors.Gray,anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 118;BA.debugLine="If ImageView1.IsInitialized=False Then ImageView1.Initialize(\"\")";
...
mostCurrent._imageview1.Initialize(mostCurrent.activityBA,"");};
 //BA.debugLineNum = 119;BA.debugLine="ImageView1.RemoveView";
mostCurrent._imageview1.RemoveView();
 //BA.debugLineNum = 120;BA.debugLine="ImageView1.SetBackgroundImage(legend)";
mostCurrent._imageview1.SetBackgroundImage((android.graphics.Bitmap)(mostCurrent._legend.getObject()));
 //BA.debugLineNum = 122;BA.debugLine="pnlPie.AddView(ImageView1, 10dip, 10dip, legend.Width, legend.Height)";
...
public static String  _buttoningresar_click() throws Exception{
 //BA.debugLineNum = 195;BA.debugLine="Sub ButtonIngresar_Click";
 //BA.debugLineNum = 198;BA.debugLine="If EditTextTitulo.Text.Trim=\"\" Then";
if ((mostCurrent._edittexttitulo.getText().trim()).equals("")) { 
 //BA.debugLineNum = 199;BA.debugLine="Msgbox(\"Falta ingresar el Título\",\"Error\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Falta ingresar el Título","Error",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 203;BA.debugLine="DBApp.InsertaReview(EditTextTitulo.Text,SpinnerNota.SelectedItem,SpinnerTipo.SelectedItem)";
mostCurrent._dbapp._insertareview(mostCurrent.activityBA,mostCurrent._edittexttitulo.getText(),mostCurrent._spinnernota.getSelectedItem(),mostCurrent._spinnertipo.getSelectedItem());
 //BA.debugLineNum = 205;BA.debugLine="LLenaListview";
_llenalistview();
 //BA.debugLineNum = 207;BA.debugLine="addValorGrafico(CalculaEstadistica)";
_addvalorgrafico(_calculaestadistica());
 //BA.debugLineNum = 209;BA.debugLine="Msgbox(\"Has ingresado tu Reseña correctamente\",\"Exito\")";
...
int _sumav = 0;
int _i = 0;
 //BA.debugLineNum = 125;BA.debugLine="Sub CalculaEstadistica As Map";
 //BA.debugLineNum = 127;BA.debugLine="Dim Mapa As Map";
_mapa = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 128;BA.debugLine="Dim sumaST As Int";
_sumast = 0;
 //BA.debugLineNum = 129;BA.debugLine="Dim sumaT As Int";
_sumat = 0;
 //BA.debugLineNum = 130;BA.debugLine="Dim sumaV As Int";
_sumav = 0;
 //BA.debugLineNum = 132;BA.debugLine="If Mi_Cursor.RowCount>0 Then";
if (mostCurrent._mi_cursor.getRowCount()>0) { 
 //BA.debugLineNum = 134;BA.debugLine="For i=0 To Mi_Cursor.RowCount-1";
{
final int step75 = 1;
final int limit75 = (int) (mostCurrent._mi_cursor.getRowCount()-1);
...
mostCurrent._mi_cursor.setPosition(_i);
 //BA.debugLineNum = 138;BA.debugLine="Select Mi_Cursor.GetString(\"tipo\")";
switch (BA.switchObjectToInt(mostCurrent._mi_cursor.GetString("tipo"),"Solo Título","Texto","Voz")) {
case 0:
 //BA.debugLineNum = 141;BA.debugLine="sumaST=sumaST+1";
_sumast = (int) (_sumast+1);
 break;
case 1:
 //BA.debugLineNum = 144;BA.debugLine="sumaT=sumaT+1";
_sumat = (int) (_sumat+1);
 break;
case 2:
 //BA.debugLineNum = 147;BA.debugLine="sumaV=sumaV+1";
_sumav = (int) (_sumav+1);
 break;
}
;
 ...
 //BA.debugLineNum = 155;BA.debugLine="If Mapa.IsInitialized=False Then Mapa.Initialize";
if (_mapa.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
_mapa.Initialize();};
 //BA.debugLineNum = 156;BA.debugLine="Mapa.Put(\"Solo Título\",sumaST)";
_mapa.Put((Object)("Solo Título"),(Object)(_sumast));
 //BA.debugLineNum = 157;BA.debugLine="Mapa.Put(\"Texto\",sumaT)";
_mapa.Put((Object)("Texto"),(Object)(_sumat));
 //BA.debugLineNum = 158;BA.debugLine="Mapa.Put(\"Voz\",sumaV)";
_mapa.Put((Object)("Voz"),(Object)(_sumav));
 //BA.debugLineNum = 160;BA.debugLine="sumaST = 0";
_sumast = (int) (0);
 //BA.debugLineNum = 161;BA.debugLine="sumaT = 0";
_sumat = (int) (0);
 //BA.debugLineNum = 162;BA.debugLine="sumaV = 0";
_sumav = (int) (0);
 //BA.debugLineNum = 164;BA.debugLine="Return Mapa";
...
int _i = 0;
 //BA.debugLineNum = 229;BA.debugLine="Sub EditTextBusca_TextChanged (Old As String, New As String)";
 //BA.debugLineNum = 231;BA.debugLine="Mi_CursorBusca=DBApp.Mi_BD.ExecQuery(\"SELECT id_review, titulo, nota, tipo FROM REVIEW WHERE titulo LIKE '\"& New &\"%' \")";
mostCurrent._mi_cursorbusca.setObject((android.database.Cursor)(mostCurrent._dbapp._mi_bd.ExecQuery("SELECT id_review, titulo, nota, tipo FROM REVIEW WHERE titulo LIKE '"+_new+"%' ")));
 //BA.debugLineNum = 233;BA.debugLine="ListViewResultados.Clear";
mostCurrent._listviewresultados.Clear();
 //BA.debugLineNum = 235;BA.debugLine="If Mi_CursorBusca.RowCount>0 Then";
if (mostCurrent._mi_cursorbusca.getRowCount()>0) { 
 //BA.debugLineNum = 237;BA.debugLine="For i=0 To Mi_CursorBusca.RowCount-1";
{
final int step140 = 1;
final int limit140 = (int) (mostCurrent._mi_cursorbusca.getRowCount()-1);
for (_i = (int) (0); (step140 > 0 && _i <= limit140) || (step140 < 0 && _i >= limit140); _i = ((int)(0 + _i + step140))) {
 //BA.debugLineNum = 239;BA.debugLine="Mi_CursorBusca.Position=i";
mostCurrent._mi_cursorbusca.setPosition(_i);
 //BA.debugLineNum = 240;BA.debugLine="ListViewResultados.AddTwoLines(Mi_CursorBusca.GetString(\"id_review\"),Mi_CursorBusca.GetString(\"titulo\") & \" (\"&Mi_CursorBusca.GetString(\"nota\")&\", \"& Mi_CursorBusca.GetString(\"tipo\") &\")\")";
...
public static String  _gesture_onfling(float _velocityx,float _velocityy,Object _motionevent1,Object _motionevent2) throws Exception{
 //BA.debugLineNum = 214;BA.debugLine="Sub Gesture_onFling(velocityX As Float, velocityY As Float, MotionEvent1 As Object, MotionEvent2 As Object)";
 //BA.debugLineNum = 215;BA.debugLine="Log(\"   onFling velocityX = \" & velocityX & \", velocityY = \" & velocityY & \", ev1 = \" & MotionEvent1 & \", ev2 = \" & MotionEvent2)";
anywheresoftware.b4a.keywords.Common.Log("   onFling velocityX = "+BA.NumberToString(_velocityx)+", velocityY = "+BA.NumberToString(_velocityy)+", ev1 = "+BA.ObjectToString(_motionevent1)+", ev2 = "+BA.ObjectToString(_motionevent2));
 //BA.debugLineNum = 216;BA.debugLine="If velocityX<0 Then";
if (_velocityx<0) { 
 //BA.debugLineNum = 217;BA.debugLine="TabHost1.CurrentTab=(TabHost1.CurrentTab+1) Mod TabHost1.TabCount";
mostCurrent._tabhost1.setCurrentTab((int) ((mostCurrent._tabhost1.getCurrentTab()+1)%mostCurrent._tabhost1.getTabCount()));
 }else {
 //BA.debugLineNum = 219;BA.debugLine="If TabHost1.CurrentTab=0 Then";
if (mostCurrent._tabhost1.getCurrentTab()==0) { 
 //BA.debugLineNum = 220;BA.debugLine="TabHost1.CurrentTab=TabHost1.TabCount-1";
mostCurrent._tabhost1.setCurrentTab((int) (mostCurrent._tabhost1.getTabCount()-1));
 }else {
 //BA.debugLineNum = 222;BA.debugLine="TabHost1.CurrentTab=(TabHost1.CurrentTab-1) Mod TabHost1.TabCount";
mostCurrent._tabhost1.setCurrentTab((int) ((mostCurrent._tabhost1.getCurrentTab()-1)%mostCurrent._tabhost1.getTabCount()));
 };
 };
...
dbapp._process_globals();
 ...
 //BA.debugLineNum = 28;BA.debugLine="Dim GD As GestureDetector";
mostCurrent._gd = new flm.b4a.gesturedetector.GestureDetectorForB4A();
 //BA.debugLineNum = 29;BA.debugLine="Dim pnlPie As Panel";
...
mostCurrent._legend = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 35;BA.debugLine="Private SpinnerNota As Spinner";
mostCurrent._spinnernota = new anywheresoftware.b4a.objects.SpinnerWrapper();
 //BA.debugLineNum = 36;BA.debugLine="Private ListViewNotas As ListView";
mostCurrent._listviewnotas = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 38;BA.debugLine="Private EditTextTitulo As EditText";
mostCurrent._edittexttitulo = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 40;BA.debugLine="Private SpinnerTipo As Spinner";
mostCurrent._spinnertipo = new anywheresoftware.b4a.objects.SpinnerWrapper();
 //BA.debugLineNum = 42;BA.debugLine="Dim Mi_Cursor As Cursor' cursor para almacenar y recorrer una respuesta de un SELECT";
mostCurrent._mi_cursor = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 43;BA.debugLine="Dim Mi_CursorBusca As Cursor";
mostCurrent._mi_cursorbusca = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 44;BA.debugLine="Private EditTextBusca As EditText";
mostCurrent._edittextbusca = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 45;BA.debugLine="Private ListViewResultados As ListView";
mostCurrent._listviewresultados = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 46;BA.debugLine="Private LabelAcelerometro As Label";
mostCurrent._labelacelerometro = new anywheresoftware.b4a.objects.LabelWrapper();
...
int _ret = 0;
 //BA.debugLineNum = 268;BA.debugLine="Sub InputDialogTitulo(posicion As Int)";
 //BA.debugLineNum = 269;BA.debugLine="Dim Id As InputDialog";
_id = new anywheresoftware.b4a.agraham.dialogs.InputDialog();
 //BA.debugLineNum = 270;BA.debugLine="Id.Hint = \"Escribe Aquí\"";
_id.setHint("Escribe Aquí");
 //BA.debugLineNum = 271;BA.debugLine="Id.HintColor = Colors.ARGB(196, 255, 140, 0)";
_id.setHintColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (196),(int) (255),(int) (140),(int) (0)));
 //BA.debugLineNum = 273;BA.debugLine="Dim ret As Int = Id.Show(\"Escribe el Título Nuevo\", \"Edita Título\", \"Cambiar\", \"Cancelar\",\"\", Null)";
_ret = _id.Show("Escribe el Título Nuevo","Edita Título","Cambiar","Cancelar","",mostCurrent.activityBA,(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 275;BA.debugLine="If ret = -1 Then";
if (_ret==-1) { 
 //BA.debugLineNum = 276;BA.debugLine="DBApp.EditaReview(Id.Input,posicion)";
mostCurrent._dbapp._editareview(mostCurrent.activityBA,_id.getInput(),BA.NumberToString(_posicion));
 };
 //BA.debugLineNum = 280;BA.debugLine="If ret = -3 Then";
if (_ret==-3) { 
 };
...
int _mensaje = 0;
 //BA.debugLineNum = 247;BA.debugLine="Sub ListViewResultados_ItemLongClick (Position As Int, Value As Object)";
 //BA.debugLineNum = 249;BA.debugLine="Dim mensaje As Int";
_mensaje = 0;
 //BA.debugLineNum = 250;BA.debugLine="mensaje = Msgbox2(\"Opciones\",\"\",\"Editar\",\"Cancelar\",\"Eliminar\",Null)";
_mensaje = anywheresoftware.b4a.keywords.Common.Msgbox2("Opciones","","Editar","Cancelar","Eliminar",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
 //BA.debugLineNum = 251;BA.debugLine="Select mensaje";
...
case 0:
 //BA.debugLineNum = 253;BA.debugLine="Log(\"Se pulsó Editar\")";
anywheresoftware.b4a.keywords.Common.Log("Se pulsó Editar");
 //BA.debugLineNum = 255;BA.debugLine="InputDialogTitulo(ListViewResultados.GetItem(Position))";
_inputdialogtitulo((int)(BA.ObjectToNumber(mostCurrent._listviewresultados.GetItem(_position))));
 break;
case 1:
 //BA.debugLineNum = 258;BA.debugLine="DBApp.EliminaReview(ListViewResultados.GetItem(Position))";
mostCurrent._dbapp._eliminareview(mostCurrent.activityBA,BA.ObjectToString(mostCurrent._listviewresultados.GetItem(_position)));
 break;
case 2:
 //BA.debugLineNum = 261;BA.debugLine="Log(\"Se pulsó Cancelar\")";
...
int _i = 0;
 //BA.debugLineNum = 175;BA.debugLine="Sub LLenaListview";
 //BA.debugLineNum = 177;BA.debugLine="Mi_Cursor=DBApp.Mi_BD.ExecQuery(\"SELECT titulo, nota, tipo FROM REVIEW\")";
mostCurrent._mi_cursor.setObject((android.database.Cursor)(mostCurrent._dbapp._mi_bd.ExecQuery("SELECT titulo, nota, tipo FROM REVIEW")));
 //BA.debugLineNum = 179;BA.debugLine="ListViewNotas.Clear";
mostCurrent._listviewnotas.Clear();
 //BA.debugLineNum = 180;BA.debugLine="EditTextTitulo.Text=\"\"";
mostCurrent._edittexttitulo.setText((Object)(""));
 //BA.debugLineNum = 182;BA.debugLine="If Mi_Cursor.RowCount>0 Then";
if (mostCurrent._mi_cursor.getRowCount()>0) { 
 //BA.debugLineNum = 184;BA.debugLine="For i=0 To Mi_Cursor.RowCount-1";
{
final int step108 = 1;
final int limit108 = (int) (mostCurrent._mi_cursor.getRowCount()-1);
for (_i = (int) (0); (step108 > 0 && _i <= limit108) || (step108 < 0 && _i >= limit108); _i = ((int)(0 + _i + step108))) {
 //BA.debugLineNum = 186;BA.debugLine="Mi_Cursor.Position=i";
mostCurrent._mi_cursor.setPosition(_i);
 //BA.debugLineNum = 187;BA.debugLine="ListViewNotas.AddTwoLines(Mi_Cursor.GetString(\"nota\"),Mi_Cursor.GetString(\"titulo\") & \" (\"& Mi_Cursor.GetString(\"tipo\") &\")\")";
...
double _i = 0;
 //BA.debugLineNum = 167;BA.debugLine="Sub LLenaSpinnerNota";
 //BA.debugLineNum = 168;BA.debugLine="Dim I As Double=7.0";
_i = 7.0;
 //BA.debugLineNum = 169;BA.debugLine="Do While I>=1.0";
while (_i>=1.0) {
 //BA.debugLineNum = 170;BA.debugLine="SpinnerNota.add(Round2(I,1))";
mostCurrent._spinnernota.Add(BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round2(_i,(int) (1))));
 //BA.debugLineNum = 171;BA.debugLine="I=I-0.1";
_i = _i-0.1;
 }
;
...
public static String  _sensor_accelerometerchanged(float _x,float _y,float _z) throws Exception{
 //BA.debugLineNum = 285;BA.debugLine="Sub Sensor_AccelerometerChanged (X As Float, Y As Float, Z As Float)";
 //BA.debugLineNum = 286;BA.debugLine="LabelAcelerometro.Text=\"X:\"&X&\" |Y:\"&Y&\" |Z:\"&Z";
mostCurrent._labelacelerometro.setText((Object)("X:"+BA.NumberToString(_x)+" |Y:"+BA.NumberToString(_y)+" |Z:"+BA.NumberToString(_z)));
 //BA.debugLineNum = 287;BA.debugLine="End Sub";
return "";
}
public static String  _tabbuscar() throws Exception{
 //BA.debugLineNum = 95;BA.debugLine="Sub TabBuscar";
 //BA.debugLineNum = 96;BA.debugLine="TabHost1.AddTab(\"Buscador\",\"layoutBusca\")";
...
anywheresoftware.b4a.objects.PanelWrapper _p = null;
 //BA.debugLineNum = 86;BA.debugLine="Sub TabGraficoPie";
 //BA.debugLineNum = 87;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 88;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 89;BA.debugLine="pnlPie.Initialize(\"pnlPie\")";
mostCurrent._pnlpie.Initialize(mostCurrent.activityBA,"pnlPie");
 //BA.debugLineNum = 90;BA.debugLine="p.AddView(pnlPie, 0, 0, 100%x, 100%y - 100dip)";
_p.AddView((android.view.View)(mostCurrent._pnlpie.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),(int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100))));
 //BA.debugLineNum = 91;BA.debugLine="TabHost1.AddTab2(\"Resumen\", p)";

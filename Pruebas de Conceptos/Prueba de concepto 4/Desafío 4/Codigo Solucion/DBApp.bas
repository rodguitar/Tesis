...
Sub InsertaReview(titulo As String, nota As String, tipo As String, comentario_texto As String,nombre_voz As String)
	Dim fecha As String
	Try
	...
	Try
		Mi_BD.ExecNonQuery2("INSERT INTO REVIEW (titulo,nota,tipo,comentario_texto,nombre_voz,fecha_registro) VALUES (?,?,?,?,?,'"&fecha&"')", Array As Object(titulo,nota,tipo,comentario_texto,nombre_voz))
	Catch
		Log("catch ERROR INSERT INTO REVIEW: "&LastException.Message)
	End Try
End Sub

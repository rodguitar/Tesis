...
_mi_bd.ExecNonQuery("UPDATE REVIEW SET titulo='"+_titulo+"' WHERE id_review='"+_id_review+"'");
 //BA.debugLineNum = 48;BA.debugLine="Log(\"OK UPDATE de UpLibretaConductor en libreta Realizado.\")";
anywheresoftware.b4a.keywords.Common.Log("OK UPDATE de UpLibretaConductor en libreta Realizado.");
 } 
       catch (Exception e38) {
			(_ba.processBA == null ? _ba : _ba.processBA).setLastException(e38); //BA.debugLineNum = 51;BA.debugLine="Log(\"catch UPDATE de UpLibretaConductor en libreta  DBApp   \" & LastException.Message)";
...
_mi_bd.ExecNonQuery("DELETE from REVIEW where id_review= '"+_id_review+"' ");
 //BA.debugLineNum = 60;BA.debugLine="Log(\"OK UPDATE de UpLibretaConductor en libreta Realizado.\")";
anywheresoftware.b4a.keywords.Common.Log("OK UPDATE de UpLibretaConductor en libreta Realizado.");
 } 
       catch (Exception e46) {
			(_ba.processBA == null ? _ba : _ba.processBA).setLastException(e46); //BA.debugLineNum = 63;BA.debugLine="Log(\"catch UPDATE de UpLibretaConductor en libreta  DBApp   \" & LastException.Message)";
anywheresoftware.b4a.keywords.Common.Log("catch UPDATE de UpLibretaConductor en libreta  DBApp   "+anywheresoftware.b4a.keywords.Common.LastException(_ba).getMessage());
 };

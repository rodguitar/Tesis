...
//BA.debugLineNum = 31;BA.debugLine="ButtonStop.SetLeftAndRight(SpinnerNota.Right+5,SpinnerTipo.Left-5)"[layout1/General script]
views.get("buttonstop").vw.setLeft((int)((views.get("spinnernota").vw.getLeft() + views.get("spinnernota").vw.getWidth())+5d));
views.get("buttonstop").vw.setWidth((int)((views.get("spinnertipo").vw.getLeft())-5d - ((views.get("spinnernota").vw.getLeft() + views.get("spinnernota").vw.getWidth())+5d)));
//BA.debugLineNum = 32;BA.debugLine="ButtonStop.SetTopAndBottom(SpinnerTipo.Top,SpinnerTipo.Bottom)"[layout1/General script]
views.get("buttonstop").vw.setTop((int)((views.get("spinnertipo").vw.getTop())));
views.get("buttonstop").vw.setHeight((int)((views.get("spinnertipo").vw.getTop() + views.get("spinnertipo").vw.getHeight()) - ((views.get("spinnertipo").vw.getTop()))));

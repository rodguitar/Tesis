...
public static anywheresoftware.b4a.agraham.ioio.B4AIOIO.B4AAnalogueInputWrapper _pin39_fotoresistor = null;
...
if (_firsttime) { 
 //BA.debugLineNum = 42;BA.debugLine="IOIOConnect";
_ioioconnect();
 //BA.debugLineNum = 43;BA.debugLine="configuracionSPI_pot";
_configuracionspi_pot();
 //BA.debugLineNum = 44;BA.debugLine="StartService(Servicio)";
...
public static String  _actualizalabelvalor() throws Exception{
 //BA.debugLineNum = 92;BA.debugLine="Sub ActualizaLabelValor";
 //BA.debugLineNum = 93;BA.debugLine="LabelValorAnalogo.Text = ValorAnalogoFotoR";
...
Object[] _slavemodes = null;
 //BA.debugLineNum = 81;BA.debugLine="Sub configuracionSPI_pot";
 //BA.debugLineNum = 82;BA.debugLine="Dim slavepins() As Int";
_slavepins = new int[(int) (0)];
;
 //BA.debugLineNum = 84;BA.debugLine="slavepins = Array As Int(7)";
_slavepins = new int[]{(int) (7)};
 //BA.debugLineNum = 85;BA.debugLine="Dim slavemodes() As Object";
...
;
 //BA.debugLineNum = 87;BA.debugLine="slavemodes = Array As Object( SPI.OP_NORMAL)";
_slavemodes = new Object[]{(Object)(_spi.OP_NORMAL)};
 //BA.debugLineNum = 88;BA.debugLine="SPI=YOYO.OpenSpiMaster(9, SPI.IP_PULL_UP, 3, SPI.";
...
public static String  _ioioclose() throws Exception{
 //BA.debugLineNum = 70;BA.debugLine="Sub IOIOClose";
 //BA.debugLineNum = 71;BA.debugLine="Try";
try { //BA.debugLineNum = 72;BA.debugLine="pin39_fotoresistor.Close";
_pin39_fotoresistor.Close();
 //BA.debugLineNum = 73;BA.debugLine="SPI.Close";
_spi.Close();
 //BA.debugLineNum = 74;BA.debugLine="YOYO.Disconnect";
_yoyo.Disconnect();
 //BA.debugLineNum = 75;BA.debugLine="YOYO.WaitForDisconnect";
_yoyo.WaitForDisconnect();
 } 
       catch (Exception e40) {
			processBA.setLastException(e40); //BA.debugLineNum = 77;BA.debugLine="Log(\"YOYO Close Exception: \"& LastException.Mess";
...
public static String  _ioioconnect() throws Exception{
 //BA.debugLineNum = 59;BA.debugLine="Sub IOIOConnect";
 //BA.debugLineNum = 60;BA.debugLine="Try";
try { //BA.debugLineNum = 61;BA.debugLine="YOYO.Initialize";
_yoyo.Initialize();
 //BA.debugLineNum = 62;BA.debugLine="YOYO.WaitForConnect";
_yoyo.WaitForConnect();
 //BA.debugLineNum = 63;BA.debugLine="pin39_fotoresistor= YOYO.OpenAnalogInput(39)";
_pin39_fotoresistor.setObject((ioio.lib.api.AnalogInput)(_yoyo.OpenAnalogInput((int) (39))));
 } 
       catch (Exception e30) {
			processBA.setLastException(e30); //BA.debugLineNum = 66;BA.debugLine="Log(\"YOYO Exception: \"& LastException.Message)";
...
_yoyo = new anywheresoftware.b4a.agraham.ioio.B4AIOIO();
 //BA.debugLineNum = 20;BA.debugLine="Dim SPI As SpiMaster";
_spi = new anywheresoftware.b4a.agraham.ioio.B4AIOIO.B4ASpiMaster();
 //BA.debugLineNum = 22;BA.debugLine="Dim wBuffer(2) As Byte";
_wbuffer = new byte[(int) (2)];
;
 //BA.debugLineNum = 24;BA.debugLine="Dim ValorAnalogoFotoR As Float";
_valoranalogofotor = 0f;
 //BA.debugLineNum = 25;BA.debugLine="Dim pin39_fotoresistor As AnalogInput";
_pin39_fotoresistor = new anywheresoftware.b4a.agraham.ioio.B4AIOIO.B4AAnalogueInputWrapper();
 //BA.debugLineNum = 26;BA.debugLine="End Sub";
return "";
}
public static String  _startservicio_click() throws Exception{
 //BA.debugLineNum = 96;BA.debugLine="Sub StartServicio_click";
 //BA.debugLineNum = 97;BA.debugLine="StartService(Servicio)";
anywheresoftware.b4a.keywords.Common.StartService(mostCurrent.activityBA,(Object)(mostCurrent._servicio.getObject()));
 //BA.debugLineNum = 98;BA.debugLine="End Sub";
return "";
}
public static String  _stopservicio_click() throws Exception{
 //BA.debugLineNum = 100;BA.debugLine="Sub StopServicio_click";
 //BA.debugLineNum = 101;BA.debugLine="wBuffer(1)=0";
_wbuffer[(int) (1)] = (byte) (0);
 //BA.debugLineNum = 102;BA.debugLine="SPI.WriteRead(0,wBuffer,wBuffer.Length,2,Null,0)";
_spi.WriteRead((int) (0),_wbuffer,_wbuffer.length,(int) (2),(byte[])(anywheresoftware.b4a.keywords.Common.Null),(int) (0));
 //BA.debugLineNum = 103;BA.debugLine="StopService(Servicio)";

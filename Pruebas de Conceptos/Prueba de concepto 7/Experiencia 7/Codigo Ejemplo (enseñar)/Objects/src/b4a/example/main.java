...
public anywheresoftware.b4a.objects.Timer _timer_fotoresistor = null;
...
mostCurrent._activity.LoadLayout("Layout1",mostCurrent.activityBA);
 //BA.debugLineNum = 33;BA.debugLine="IOIOConnect";
_ioioconnect();
 //BA.debugLineNum = 34;BA.debugLine="Timer_Fotoresistor.Initialize(\"LoopFotoresistor\",";
mostCurrent._timer_fotoresistor.Initialize(processBA,"LoopFotoresistor",(long) (100));
 //BA.debugLineNum = 35;BA.debugLine="Timer_Fotoresistor.Enabled=True";
mostCurrent._timer_fotoresistor.setEnabled(anywheresoftware.b4a.keywords.Common.True);
...
if (_userclosed) { 
 //BA.debugLineNum = 44;BA.debugLine="IOIOClose";
_ioioclose();
...
mostCurrent._pin39_fotoresistor = new anywheresoftware.b4a.agraham.ioio.B4AIOIO.B4AAnalogueInputWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Dim Timer_Fotoresistor As Timer";
mostCurrent._timer_fotoresistor = new anywheresoftware.b4a.objects.Timer();
 //BA.debugLineNum = 27;BA.debugLine="Private LabelValorAnalogo As Label";
...
try { //BA.debugLineNum = 62;BA.debugLine="pin39_fotoresistor.Close";
...
_yoyo.WaitForDisconnect();
			...
			processBA.setLastException(e37); //BA.debugLineNum = 66;BA.debugLine="Log(\"YOYO Close Exception: \"& LastException.Mess";
...
_yoyo.WaitForConnect();
 //BA.debugLineNum = 53;BA.debugLine="pin39_fotoresistor= YOYO.OpenAnalogInput(39)";
mostCurrent._pin39_fotoresistor.setObject((ioio.lib.api.AnalogInput)(_yoyo.OpenAnalogInput((int) (39))));
 } 
       catch (Exception e28) {
			processBA.setLastException(e28); //BA.debugLineNum = 56;BA.debugLine="Log(\"YOYO Exception: \"& LastException.Message)";
...
public static String  _loopfotoresistor_tick() throws Exception{
 //BA.debugLineNum = 70;BA.debugLine="Sub LoopFotoresistor_Tick";
 //BA.debugLineNum = 71;BA.debugLine="LabelValorAnalogo.Text = pin39_fotoresistor.Read";
mostCurrent._labelvaloranalogo.setText((Object)(mostCurrent._pin39_fotoresistor.Read()));

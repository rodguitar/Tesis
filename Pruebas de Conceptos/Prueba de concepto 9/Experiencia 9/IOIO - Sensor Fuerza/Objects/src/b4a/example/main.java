...
public static anywheresoftware.b4a.agraham.ioio.B4AIOIO.B4AAnalogueInputWrapper _pin33_sensorfuerza = null;
public static anywheresoftware.b4a.agraham.ioio.B4AIOIO.B4APwmOutputWrapper _pin11_zumbador = null;
public static float _valoranalogosensorf = 0f;
...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 35;BA.debugLine="Activity.AddMenuItem(\"Iniciar Servicio\",\"StartSer";
mostCurrent._activity.AddMenuItem("Iniciar Servicio","StartServicio");
 //BA.debugLineNum = 36;BA.debugLine="Activity.AddMenuItem(\"Detener Servicio\",\"StopServ";
mostCurrent._activity.AddMenuItem("Detener Servicio","StopServicio");
 //BA.debugLineNum = 37;BA.debugLine="Activity.OpenMenu";
...
public static String  _actualizalabelvalor() throws Exception{
 //BA.debugLineNum = 70;BA.debugLine="Sub ActualizaLabelValor";
 //BA.debugLineNum = 73;BA.debugLine="LabelValorAnalogo.Text = ValorAnalogoSensorF";
mostCurrent._labelvaloranalogo.setText((Object)(_valoranalogosensorf));
...
_yoyo.WaitForDisconnect();
			...
			processBA.setLastException(e35); //BA.debugLineNum = 66;BA.debugLine="Log(\"YOYO Close Exception: \"& LastException.Mess";
...
_pin11_zumbador.setObject((ioio.lib.api.PwmOutput)(_yoyo.OpenPwmOutput((int) (11),_pin11_zumbador.OP_NORMAL,(int) (2000))));
 } 
       catch (Exception e26) {
			processBA.setLastException(e26); //BA.debugLineNum = 56;BA.debugLine="Log(\"YOYO Exception: \"& LastException.Message)";
...
_yoyo = new anywheresoftware.b4a.agraham.ioio.B4AIOIO();
 //BA.debugLineNum = 19;BA.debugLine="Dim pin33_SensorFuerza As AnalogInput";
_pin33_sensorfuerza = new anywheresoftware.b4a.agraham.ioio.B4AIOIO.B4AAnalogueInputWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Dim pin11_Zumbador As PwmOutput";
_pin11_zumbador = new anywheresoftware.b4a.agraham.ioio.B4AIOIO.B4APwmOutputWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Dim ValorAnalogoSensorF As Float";
_valoranalogosensorf = 0f;
